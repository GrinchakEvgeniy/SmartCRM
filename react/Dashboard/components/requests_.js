...
export async function postSalaryFetch(data) {
    const options = {
        method: 'POST', // *GET, POST, PUT, DELETE, etc.
        body: JSON.stringify(data),
        headers: {
    ...
    const response = await fetch('/api/post-salary', options);
    const result = await response.json();
    return result;
}

export async function deleteSalaryFetch(data) {
    const options = {
        method: 'DELETE', // *GET, POST, PUT, DELETE, etc.
        body: JSON.stringify(data),
        headers: {
    ...
    const response = await fetch('/api/delete-salary', options);
    const result = await response.json();
    return result;
}

export async function putSalaryFetch(data) {
    const options = {
        method: 'PUT', // *GET, POST, PUT, DELETE, etc.
        body: JSON.stringify(data),
        headers: {
    ...
    const response = await fetch('/api/put-salary', options);
    const result = await response.json();
    return result;
}