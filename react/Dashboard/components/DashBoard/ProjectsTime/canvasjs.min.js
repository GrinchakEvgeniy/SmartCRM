...
(function () {
    ...
    function Xa(k, m, u) {
        "millisecond" === u
            ...
            : "year" === u && k.setFullYear(k.getFullYear() + 1 * m);
        return k;
    }
    function X(k, m) {
        var u = !1;
    ...
    function fb(k, m) {
        ...
        for (0 > r && (r += u); r < u; r++) if (r in this && this[r] === k) return r;
        return -1;
    }
    function r(k) {
    ...
    function Ya(k, m, u) {
        ...
        if (isNaN(w)) {
            try {
                k = "position:absolute; left:0px; top:-20000px; padding:0px;margin:0px;border:none;white-space:pre;line-height:normal;font-family:" + k + "; font-size:" + m + "px; font-weight:" + u + ";";
                if (!wa) {
    ...
    function J(k, m, u, w, Ha) {
        w = w || [];
        Ha = r(Ha) ? (hb ? { passive: !1, capture: !1 } : !1) : Ha;
        w.push([k, m, u, Ha]);
        return k.addEventListener
            ? (k.addEventListener(m, u, Ha), u)
            : k.attachEvent
            ? ((w = function (m) {
                  m = m || window.event;
                  m.preventDefault =
    ...
    function ib(k) {
        ...
        if (!k._dropdownMenu && k.exportEnabled && w) {
            ...
            u = document.createElement("div");
            u.style.cssText = "padding: 12px 8px 12px 8px";
            u.innerHTML = k._cultureInfo.saveJPGText;
            u.style.backgroundColor = k.toolbar.backgroundColor;
            u.style.color = k.toolbar.fontColor;
            k._dropdownMenu.appendChild(u);
            J(
    ...
    function jb(k) {
        if (!kb) {
            var m = !1,
                u = !1;
            "undefined" === typeof qa.Chart.creditHref ? ((k.creditHref = Y("")), (k.creditText = Y(""))) : ((m = k.updateOption("creditText")), (u = k.updateOption("creditHref")));
    ...
    function va(k, m, u) {
        ...
        m.getAttribute("state") !== u &&
            (m.setAttribute("state", u),
            ...
            m.setAttribute("title", k._cultureInfo[u + "Text"]),
            (m.innerHTML = "<img style='height:95%; pointer-events: none;' src='" + lb[u].image + "' alt='" + k._cultureInfo[u + "Text"] + "' />"));
    }
    function Ma() {
    ...
    function V(k, m, u, w, y) {
        ...
        this.theme && r(this.parent) && r(m) && r(w)
            ...
            : this.parent &&
              ...
              (null === w ? (k = this.parent.themeOptions[m]) : 0 < this.parent.themeOptions[m].length && ((w = Math.min(this.parent.themeOptions[m].length - 1, w)), (k = this.parent.themeOptions[m][w])));
        this.themeOptions = k;
        this.options = u ? u : { _isPlaceholder: !0 };
    ...
    function ya(k, m) {
        ...
        if (r(this.options.margin) && k.options.subtitles)
            for (var u = k.options.subtitles, w = 0; w < u.length; w++)
                if (
                    ((r(u[w].horizontalAlign) && "center" === this.horizontalAlign) || u[w].horizontalAlign === this.horizontalAlign) &&
                    ((r(u[w].verticalAlign) && "top" === this.verticalAlign) || u[w].verticalAlign === this.verticalAlign) &&
                    !u[w].dockInsidePlotArea === !this.dockInsidePlotArea
                ) {
                    this.margin = 0;
                    break;
                }
    ...
    (function () {
        ...
        T.pro = { sCH: qa[T.fSDec("Bi`su")][T.fSDec("bsdehuIsdg")] };
        T.pos = ["cm", "cs", "um"];
        T._fTWm = function (k) {
    ...
    var hb = (function () {
        ...
        ea = function (k, m, u) {
            ...
            for (J = F = L = Q = N = 0; 0 < M.length; )
                if (((m = M.pop()), "#" === m || "0" === m))
                    ...
                    } else 0 < D.length ? ((u = D.pop() + u), Q++, J++) : "0" === m && ((u = "0" + u), Q++, J++), 0 === J % F && L === R && 0 < D.length && (u = y + u);
                else
                    ("E" !== m[0] && "e" !== m[0]) || "0" !== m[m.length - 1] || !/[eE][+-]*[0]+/.test(m)
                        ? "," === m
                            ? (L++, (F = J), (J = 0), 0 < D.length && (u = y + u))
                            : (u = 1 < m.length && (('"' === m[0] && '"' === m[m.length - 1]) || ("'" === m[0] && "'" === m[m.length - 1])) ? m.slice(1, m.length - 1) + u : m + u)
                        : ((m = 0 > V ? m.replace("+", "").replace("-", "") : m.replace("-", "")),
                          (u += m.replace(/[0]+/, function (a) {
                              return X(V, a.length);
                          })));
            y = "";
            for (M = !1; 0 < T.length; )
        ...
        Pa = function (k) {
            var m = 0,
                u = 0;
            k = k || window.event;
            k.offsetX || 0 === k.offsetX ? ((m = k.offsetX), (u = k.offsetY)) : k.layerX || 0 == k.layerX ? ((m = k.layerX), (u = k.layerY)) : ((m = k.pageX - k.target.offsetLeft), (u = k.pageY - k.target.offsetTop));
            return { x: m, y: u };
        },
        ab = !0,
        ...
        ca = function (k, m, u, r, w, y, D, F, N, M, T, Q, J) {
            ...
            !0 === N &&
                ...
                k.lineTo(r, u),
                k.closePath(),
                (D = k.createLinearGradient((r + m) / 2, u + H, (r + m) / 2, u)),
                D.addColorStop(0, y),
            ...
            !0 === M &&
                ...
                k.lineTo(r, w),
                k.closePath(),
                (D = k.createLinearGradient((r + m) / 2, w - H, (r + m) / 2, w)),
                D.addColorStop(0, y),
                D.addColorStop(1, "rgba(255, 255, 255, .4)"),
                (k.fillStyle = D),
                k.fill(),
            ...
            !0 === T &&
                ...
                k.lineTo(m, w),
                k.closePath(),
                (D = k.createLinearGradient(m + H, (w + u) / 2, m, (w + u) / 2)),
                D.addColorStop(0, y),
            ...
            !0 === Q &&
                ...
                k.lineTo(r - H, w - H),
                k.lineTo(r, w),
                (D = k.createLinearGradient(r - H, (w + u) / 2, r, (w + u) / 2)),
                D.addColorStop(0, y),
                D.addColorStop(1, "rgba(255, 255, 255, 0.1)"),
                (k.fillStyle = D),
                D.addColorStop(0, y),
        ...
        db =
            ...
            (-1 !== window[Y("mnb`uhno")].href.indexOf(Y("b`ow`rkr/bnl")) || -1 !== window[Y("mnb`uhno")].href.indexOf(Y("gdonqhy/bnl")) || -1 !== window[Y("mnb`uhno")].href.indexOf(Y("gheemd"))),
    ...
    V.prototype.addTo = function (k, m, r, w) {
        ...
        y.hasOwnProperty(k) || (y.publicProperties && y.publicProperties.hasOwnProperty(k) && "readWrite" === y.publicProperties[k])
            ...
            : window.console &&
              (y.publicProperties && y.publicProperties.hasOwnProperty(k) && "readOnly" === y.publicProperties[k]
                  ? window.console.log('Property "' + k + '" is read-only.')
                  : window.console.log('Property "' + k + "\" doesn't exist. Please check for typo."));
    };
    ...
    V.prototype.updateOption = function (k) {
        ...
        var m = qa[this._defaultsKey],
            ...
            H = this._index;
        this.theme && r(this.parent) && r(F) && r(H)
            ...
            : this.parent &&
              ...
              (null === H ? (w = this.parent.themeOptions[F]) : 0 < this.parent.themeOptions[F].length && ((w = Math.min(this.parent.themeOptions[F].length - 1, H)), (w = this.parent.themeOptions[F][w])));
        this.themeOptions = w;
    ...
    V.prototype.dispatchEvent = function (k, m, r) {
        if (k && this._eventListeners[k]) {
            m = m || {};
            for (var w = this._eventListeners[k], y = 0; y < w.length; y++) w[y].eventHandler.call(w[y].context, m);
        }
        ...
        if (this.text) {
            ...
            "top" === this.verticalAlign || "bottom" === this.verticalAlign
                ? ("top" === this.verticalAlign ? ((y = m.y1 + 2), (J = "top")) : "bottom" === this.verticalAlign && ((y = m.y2 - 2 - M.height), (J = "bottom")),
                  "left" === this.horizontalAlign ? (w = m.x1 + 2) : "center" === this.horizontalAlign ? (w = m.x1 + m.width / 2 - M.width / 2) : "right" === this.horizontalAlign && (w = m.x2 - 2 - M.width - D),
                  (N = this.horizontalAlign),
                  (this.width = M.width),
                  (this.height = M.height))
                : "center" === this.verticalAlign &&
                  ("left" === this.horizontalAlign
                      ? ((w = m.x1 + 2), (y = m.y2 - 2 - (this.maxWidth / 2 - M.width / 2)), (F = -90), (J = "left"), (this.width = M.height), (this.height = M.width))
                      : "right" === this.horizontalAlign
                      ? ((w = m.x2 - 2), (y = m.y1 + 2 + (this.maxWidth / 2 - M.width / 2)), (F = 90), (J = "right"), (this.width = M.height), (this.height = M.width))
                      : "center" === this.horizontalAlign && ((y = k.y1 + (k.height / 2 - M.height / 2)), (w = k.x1 + (k.width / 2 - M.width / 2)), (J = "center"), (this.width = M.width), (this.height = M.height)),
                  (N = "center"));
            H.x = w;
            H.y = y;
            H.angle = F;
            H.horizontalAlign = N;
            this._textBlock = H;
            k.layoutManager.registerSpace(J, { width: this.width + ("left" === J || "right" === J ? this.margin + 2 : 0), height: this.height + ("top" === J || "bottom" === J ? this.margin + 2 : 0) });
    ...
    y = Qa.Chart = (function () {
        ...
        function u(a, d) {
            for (var c = [], b, e = 0; e < a.length; e++)
                if (0 == e) c.push(a[0]);
                    ...
                    var A = (a[l].x - a[f].x) / b;
                    b = (a[l].y - a[f].y) / b;
                    c[c.length] = (a[t].x > a[f].x && 0 < A) || (a[t].x < a[f].x && 0 > A) ? { x: a[t].x + A / 3, y: a[t].y + b / 3 } : { x: a[t].x, y: a[t].y + b / 9 };
                    t = e;
                    f = 0 === t ? 0 : t - 1;
                    l = t === a.length - 1 ? t : t + 1;
        ...
        function y(a, d, c, b, e, f, l, t, A, h) {
            ...
            A && 0 < t.thickness
                ...
                : 0 < t.thickness && (a.moveTo(Math.round((d + b) / 2) - n, c + l.thickness / 2), a.lineTo(Math.round((d + b) / 2) - n, e - l.thickness / 2));
            a.stroke();
            ...
            for (d = 0; d < this.plotInfo.plotTypes.length; d++)
                for (var f = this.plotInfo.plotTypes[d], l = 0; l < f.plotUnits.length; l++) {
                    ...
                    "line" === t.type
                        ? (A = this.renderLine(t))
                        : "stepLine" === t.type
                        ? (A = this.renderStepLine(t))
                        : "spline" === t.type
                        ? (A = this.renderSpline(t))
                        : "column" === t.type
                        ? (A = this.renderColumn(t))
                        : "bar" === t.type
                        ? (A = this.renderBar(t))
                        : "area" === t.type
                        ? (A = this.renderArea(t))
                        : "stepArea" === t.type
                        ? (A = this.renderStepArea(t))
                        : "splineArea" === t.type
                        ? (A = this.renderSplineArea(t))
                        : "stackedColumn" === t.type
                        ? (A = this.renderStackedColumn(t))
                        : "stackedColumn100" === t.type
                        ? (A = this.renderStackedColumn100(t))
                        : "stackedBar" === t.type
                        ? (A = this.renderStackedBar(t))
                        : "stackedBar100" === t.type
                        ? (A = this.renderStackedBar100(t))
                        : "stackedArea" === t.type
                        ? (A = this.renderStackedArea(t))
                        : "stackedArea100" === t.type
                        ? (A = this.renderStackedArea100(t))
                        : "bubble" === t.type
                        ? (A = A = this.renderBubble(t))
                        : "scatter" === t.type
                        ? (A = this.renderScatter(t))
                        : "pie" === t.type
                        ? this.renderPie(t)
                        : "doughnut" === t.type
                        ? this.renderPie(t)
                        : "funnel" === t.type
                        ? (A = this.renderFunnel(t))
                        : "pyramid" === t.type
                        ? (A = this.renderFunnel(t))
                        : "candlestick" === t.type
                        ? (A = this.renderCandlestick(t))
                        : "ohlc" === t.type
                        ? (A = this.renderCandlestick(t))
                        : "rangeColumn" === t.type
                        ? (A = this.renderRangeColumn(t))
                        : "error" === t.type
                        ? (A = this.renderError(t))
                        : "rangeBar" === t.type
                        ? (A = this.renderRangeBar(t))
                        : "rangeArea" === t.type
                        ? (A = this.renderRangeArea(t))
                        : "rangeSplineArea" === t.type
                        ? (A = this.renderRangeSplineArea(t))
                        : "waterfall" === t.type
                        ? (A = this.renderWaterfall(t))
                        : "boxAndWhisker" === t.type && (A = this.renderBoxAndWhisker(t));
                    ...
                    for (A = 0; A < t.dataPoints.length; A++) {
                        ...
                        if (0 < A) {
                            if (a.axisX.logarithmic) {
                                var v = b / t.dataPoints[A - 1].x;
                                1 > v && (v = 1 / v);
                                c.minDiff > v && 1 !== v && (c.minDiff = v);
                            } else (v = b - t.dataPoints[A - 1].x), 0 > v && (v *= -1), c.minDiff > v && 0 !== v && (c.minDiff = v);
                            null !== e &&
                                null !== t.dataPoints[A - 1].y &&
                                (a.axisY.logarithmic
                                    ? ((v = e / t.dataPoints[A - 1].y), 1 > v && (v = 1 / v), d.minDiff > v && 1 !== v && (d.minDiff = v))
                                    : ((v = e - t.dataPoints[A - 1].y), 0 > v && (v *= -1), d.minDiff > v && 0 !== v && (d.minDiff = v)));
                        }
                        if (b < q && !h) null !== e && (n = b);
                        else {
                            if (!h && ((h = !0), 0 < A)) {
            ...
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = [], t = [], A = Infinity, h = -Infinity, p = 0; p < a.dataSeriesIndexes.length; p++) {
                    ...
                    if ("normal" === n.axisPlacement || "xySwapped" === n.axisPlacement)
                        var ka = a.axisX.sessionVariables.newViewportMinimum
                                ? a.axisX.sessionVariables.newViewportMinimum
                                : this.options.axisX && this.options.axisX.viewportMinimum
                                ? this.options.axisX.viewportMinimum
                                : this.options.axisX && this.options.axisX.minimum
                    ...
                    for (q = 0; q < n.dataPoints.length; q++) {
                        ...
                        if (b < ka && !g) null !== n.dataPoints[q].y && (k = b);
                            ...
                            null === n.dataPoints[q].y
                                ...
                                : ((a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e), 0 <= e ? (l[b] ? (l[b] += e) : ((l[b] = e), (A = Math.min(e, A)))) : t[b] ? (t[b] += e) : ((t[b] = e), (h = Math.max(e, h))));
                        }
                    }
                    a.axisY.scaleBreaks &&
                ...
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = !1, t = !1, A = [], h = 0; h < a.dataSeriesIndexes.length; h++) {
                    ...
                    for (n = 0; n < p.dataPoints.length; n++) {
                        ...
                        if (0 < n) {
                            ...
                            } else (s = b - p.dataPoints[n - 1].x), 0 > s && (s *= -1), c.minDiff > s && 0 !== s && (c.minDiff = s);
                            r(e) ||
                                null === p.dataPoints[n - 1].y ||
                                (a.axisY.logarithmic
                                    ? 0 < e && ((s = e / p.dataPoints[n - 1].y), 1 > s && (s = 1 / s), d.minDiff > s && 1 !== s && (d.minDiff = s))
                                    : ((s = e - p.dataPoints[n - 1].y), 0 > s && (s *= -1), d.minDiff > s && 0 !== s && (d.minDiff = s)));
                        }
                        if (b < k && !q) null !== e && (v = b);
                        else {
                            if (!q && ((q = !0), 0 < n)) {
                            ...
                            b > c.viewPortMax && (c.viewPortMax = b);
                            null === e
                                ? c.viewPortMin === b && v < b && (c.viewPortMin = v)
                                : ((a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e), 0 <= e ? (l = !0) : 0 > e && (t = !0), (A[b] = A[b] ? A[b] + Math.abs(e) : Math.abs(e)));
                        }
                    }
        ...
        m.prototype._processMultiYPlotUnit = function (a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f, l, t = !1, A = 0; A < a.dataSeriesIndexes.length; A++) {
                    ...
                    for (p = 0; p < h.dataPoints.length; p++) {
                        ...
                        0 < p &&
                            (a.axisX.logarithmic
                                ? ((v = b / h.dataPoints[p - 1].x), 1 > v && (v = 1 / v), c.minDiff > v && 1 !== v && (c.minDiff = v))
                                : ((v = b - h.dataPoints[p - 1].x), 0 > v && (v *= -1), c.minDiff > v && 0 !== v && (c.minDiff = v)),
                            e &&
                                null !== e[0] &&
                                h.dataPoints[p - 1].y &&
                                null !== h.dataPoints[p - 1].y[0] &&
                                (a.axisY.logarithmic
                                    ? ((v = e[0] / h.dataPoints[p - 1].y[0]), 1 > v && (v = 1 / v), d.minDiff > v && 1 !== v && (d.minDiff = v))
                                    : ((v = e[0] - h.dataPoints[p - 1].y[0]), 0 > v && (v *= -1), d.minDiff > v && 0 !== v && (d.minDiff = v))));
                        if (!(b < ka) || n) {
                            if (!n && ((n = !0), 0 < p)) {
                                p -= 2;
                                g = k;
        ...
        m.prototype._processSpecificPlotUnit = function (a) {
            if ("waterfall" === a.type && a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = 0; l < a.dataSeriesIndexes.length; l++) {
                    ...
                    if ((t.dataPoints[A].x && t.dataPoints[A].x.getTime) || "dateTime" === t.xValueType) f = !0;
                    for (A = 0; A < t.dataPoints.length; A++)
                        "undefined" !== typeof t.dataPoints[A].isCumulativeSum && !0 === t.dataPoints[A].isCumulativeSum
                            ? ((t.dataPointEOs[A].cumulativeSumYStartValue = 0), (t.dataPointEOs[A].cumulativeSum = 0 === A ? 0 : t.dataPointEOs[A - 1].cumulativeSum), (t.dataPoints[A].y = 0 === A ? 0 : t.dataPointEOs[A - 1].cumulativeSum))
                            : "undefined" !== typeof t.dataPoints[A].isIntermediateSum && !0 === t.dataPoints[A].isIntermediateSum
                            ? ((t.dataPointEOs[A].cumulativeSumYStartValue = n),
                              (t.dataPointEOs[A].cumulativeSum = 0 === A ? 0 : t.dataPointEOs[A - 1].cumulativeSum),
                              (t.dataPoints[A].y = 0 === A ? 0 : b),
                              (n = 0 === A ? 0 : t.dataPointEOs[A - 1].cumulativeSum),
                              (b = 0))
                            : ((e = "number" !== typeof t.dataPoints[A].y ? 0 : t.dataPoints[A].y),
                              (t.dataPointEOs[A].cumulativeSumYStartValue = 0 === A ? 0 : t.dataPointEOs[A - 1].cumulativeSum),
                              (t.dataPointEOs[A].cumulativeSum = 0 === A ? e : t.dataPointEOs[A - 1].cumulativeSum + e),
                              (b += e));
                    for (A = 0; A < t.dataPoints.length; A++)
                        if (
                            ("undefined" === typeof t.dataPoints[A].x && (t.dataPoints[A].x = A + (a.axisX.logarithmic ? 1 : 0)),
                            ...
                            b < c.min && (c.min = b),
                            b > c.max && (c.max = b),
                            t.dataPointEOs[A].cumulativeSum < d.min && (d.min = t.dataPointEOs[A].cumulativeSum),
                            t.dataPointEOs[A].cumulativeSum > d.max && (d.max = t.dataPointEOs[A].cumulativeSum),
                            0 < A &&
                                (a.axisX.logarithmic
                                    ? ((n = b / t.dataPoints[A - 1].x), 1 > n && (n = 1 / n), c.minDiff > n && 1 !== n && (c.minDiff = n))
                                    : ((n = b - t.dataPoints[A - 1].x), 0 > n && (n *= -1), c.minDiff > n && 0 !== n && (c.minDiff = n)),
                                null !== e &&
                                    null !== t.dataPoints[A - 1].y &&
                                    (a.axisY.logarithmic
                                        ? ((e = t.dataPointEOs[A].cumulativeSum / t.dataPointEOs[A - 1].cumulativeSum), 1 > e && (e = 1 / e), d.minDiff > e && 1 !== e && (d.minDiff = e))
                                        : ((e = t.dataPointEOs[A].cumulativeSum - t.dataPointEOs[A - 1].cumulativeSum), 0 > e && (e *= -1), d.minDiff > e && 0 !== e && (d.minDiff = e)))),
                            !(b < q) || h)
                        ) {
                            if (!h && ((h = !0), 0 < A)) {
                                A -= 2;
                            ...
                            b > c.viewPortMax && (c.viewPortMax = b);
                            0 < A &&
                                (t.dataPointEOs[A - 1].cumulativeSum < d.viewPortMin && (d.viewPortMin = t.dataPointEOs[A - 1].cumulativeSum),
                                t.dataPointEOs[A - 1].cumulativeSum > d.viewPortMax && (d.viewPortMax = t.dataPointEOs[A - 1].cumulativeSum));
                                ...
                                for (t = 0; t < k.dataPoints.length; t++)
                                    if (
                                        (b &&
                                            ...
                                            (g = k.dataPoints[t].x.getTime ? k.dataPoints[t].x.getTime() : k.dataPoints[t].x),
                                            (n = Math.floor((g - h) / n)),
                                            g < f[n].min && (f[n].min = g),
                                            g > f[n].max && (f[n].max = g)),
                                        c)
                    ...
                    if (this._axes[l].dataInfo._dataRanges) {
                            ...
                            if (((p = h[t].max), isFinite(p)))
                                for (; t < h.length - 1; )
                                    if (((A = h[t + 1].min), isFinite(A))) {
                                        n = A - p;
                                        n > b && f.push({ diff: n, start: p, end: A });
                                        break;
                                    } else t++;
                        ...
                        for (t = 0; t < Math.min(f.length, this._axes[l].scaleBreaks.maxNumberOfAutoBreaks); t++)
                            (b = a(f[t].start, f[t].end, this._axes[l].logarithmic ? this._axes[l].dataInfo.max / this._axes[l].dataInfo.min : this._axes[l].dataInfo.max - this._axes[l].dataInfo.min, this._axes[l].logarithmic)),
                                this._axes[l].scaleBreaks.autoBreaks.push(new U(this, "autoBreaks", b, t, ++this._eventManager.lastObjectId, this._axes[l].scaleBreaks)),
        ...
        m.prototype._mouseEventHandler = function (a) {
            ...
            if (this.interactivityEnabled)
                if (this._ignoreNextEvent) this._ignoreNextEvent = !1;
                    ...
                    Ia && window.console && (window.console.log(c + " --\x3e x: " + d.x + "; y:" + d.y), e && window.console.log(a.which), "mouseup" === c && window.console.log("mouseup")),
                    !e)
                ) {
        ...
        m.prototype.validateRegion = function (a, d, c, b, e) {
            e = e || !1;
            for (var f = 0 <= this.zoomType.indexOf("x"), l = 0 <= this.zoomType.indexOf("y"), t = !1, A = [], h = [], p = [], n = 0; n < this._axes.length; n++)
            ...
            for (l = 0; l < h.length; l++) {
                ...
                if (q > g)
                    var v = g,
                        g = q,
                        q = v;
                if (n.scaleBreaks) for (v = 0; !f && v < n.scaleBreaks._appliedBreaks.length; v++) f = n.scaleBreaks._appliedBreaks[v].startValue <= q && n.scaleBreaks._appliedBreaks[v].endValue >= g;
                if (isFinite(n.dataInfo.minDiff))
                    if (
                        ((v = n.getApparentDifference(q, g, null, !0)),
                        !(
                            f ||
                            (!(this.panEnabled && n.scaleBreaks && n.scaleBreaks._appliedBreaks.length) && ((n.logarithmic && v < Math.pow(n.dataInfo.minDiff, 3)) || (!n.logarithmic && v < 3 * Math.abs(n.dataInfo.minDiff)))) ||
                            q < n.minimum ||
                            g > n.maximum
                        ))
                    )
                        A.push(n), p.push({ val1: q, val2: g }), (t = !0);
                    else if (!e) {
                        t = !1;
                        break;
                    }
            }
            return { isValid: t, axesWithValidRange: A, axesRanges: p };
        };
        ...
        m.prototype.renderIndexLabels = function (a) {
            ...
            for (a = 0; a < this._indexLabels.length; a++) {
                var h = this._indexLabels[a],
                    ...
                    n,
                    q,
                    t = la("indexLabelFontColor", h.dataPoint, h.dataSeries),
                ...
                var l = la("indexLabelFontWeight", h.dataPoint, h.dataSeries),
                ...
                if (h.dataSeries.indexLabelFormatter || h.dataPoint.indexLabelFormatter) x = { chart: this, dataSeries: h.dataSeries, dataPoint: h.dataPoint, index: h.indexKeyword, total: s.total, percent: s.percent };
                var E = h.dataPoint.indexLabelFormatter
                ...
                if (null !== E && "" !== E) {
                    ...
                    if ("stackedarea100" === p) {
                        ...
                        if (h.dataPoint.x < z.viewportMinimum || h.dataPoint.x > z.viewportMaximum || h.bounds.y1 > c.y2 || h.bounds.y2 < c.y1) continue;
                    ...
                    if ("normal" === this.plotInfo.axisPlacement) {
                        ...
                        "inside" !== s
                            ? ((e = c.y1),
                              (f = c.y2),
                              0 < C
                                  ? ((q = h.point.y - A / 2 - l - b), q < e && ((q = "auto" === s ? Math.max(h.point.y, e) + A / 2 + l + b : e + A / 2 + l + b), (u = q + A > h.point.y)))
                                  : ((q = h.point.y + A / 2 + l + b), q > f - A - l - b && ((q = "auto" === s ? Math.min(h.point.y, f) - A / 2 - l - b : f - A / 2 - l - b), (u = q < h.point.y))))
                            : ((e = Math.max(h.bounds.y1, c.y1)),
                              (f = Math.min(h.bounds.y2, c.y2)),
                              (b = 0 <= p.indexOf("range") || "error" === p ? (0 < C ? Math.max(h.bounds.y1, c.y1) + A / 2 + l : Math.min(h.bounds.y2, c.y2) - A / 2 - l) : (Math.max(h.bounds.y1, c.y1) + Math.min(h.bounds.y2, c.y2)) / 2),
                              0 < C
                                  ? ((q = Math.max(h.point.y, b)), q < e && ("bubble" === p || "scatter" === p) && (q = Math.max(h.point.y - A - l, c.y1 + l)))
                                  : ((q = Math.min(h.point.y, b)), q > f - A - l && ("bubble" === p || "scatter" === p) && (q = Math.min(h.point.y + l, c.y2 - A - l))),
                              (q = Math.min(q, f)));
                    } else
                        0 <= p.indexOf("line") || 0 <= p.indexOf("area") || 0 <= p.indexOf("scatter") ? ((s = "auto"), (e = 4)) : 0 <= p.indexOf("stacked") ? "auto" === s && (s = "inside") : "bubble" === p && (s = "inside"),
                            (q = h.point.y),
                            "inside" !== s
                                ? ((l = c.x1),
                                  (f = c.x2),
                                  0 > C
                                      ? ((n = h.point.x - ("horizontal" === x ? t : t / 2) - e - b), n < l && ((n = "auto" === s ? Math.max(h.point.x, l) + e + b : l + e + b), (u = n + t > h.point.x)))
                                      : ((n = h.point.x + ("horizontal" === x ? 0 : t / 2) + e + b),
                                        n > f - t - e - b && ((n = "auto" === s ? Math.min(h.point.x, f) - ("horizontal" === x ? t : t / 2) - e - b : f - t - e - b), (u = n < h.point.x))))
                                : ((l = Math.max(h.bounds.x1, c.x1)),
                                  Math.min(h.bounds.x2, c.x2),
                                  (b =
                                      0 <= p.indexOf("range") || "error" === p ? (0 > C ? Math.max(h.bounds.x1, c.x1) + t / 2 + e : Math.min(h.bounds.x2, c.x2) - t / 2 - e) : (Math.max(h.bounds.x1, c.x1) + Math.min(h.bounds.x2, c.x2)) / 2),
                                  (n = 0 > C ? Math.max(h.point.x, b) - ("horizontal" === x ? t / 2 : 0) : Math.min(h.point.x, b) - t / 2),
                                  (n = Math.max(n, l)));
                    "vertical" === x && (q += A / 2);
                    g.x = n;
                    g.y = q;
                    ...
                    m &&
                        "inside" !== s &&
                        ((0 > p.indexOf("bar") && ("error" !== p || !h.axisSwapped) && h.point.x > c.x1 && h.point.x < c.x2) || !u) &&
                        ((0 > p.indexOf("column") && ("error" !== p || h.axisSwapped) && h.point.y > c.y1 && h.point.y < c.y2) || !u) &&
                        ((d.lineWidth = m),
                        (d.strokeStyle = k ? k : "gray"),
                        d.setLineDash && d.setLineDash(N(v, m)),
                        d.beginPath(),
                        d.moveTo(h.point.x, h.point.y),
                        0 <= p.indexOf("bar") || ("error" === p && h.axisSwapped)
                            ? d.lineTo(n - (0 < h.direction ? 0 : -t) + ("vertical" === x ? -t / 2 : 0), q + ("vertical" === x ? -A / 2 : 0))
                            : 0 <= p.indexOf("column") || ("error" === p && !h.axisSwapped)
                            ? d.lineTo(n + ("horizontal" === x ? t / 2 : 0), q + ((0 < h.direction ? A : -A) + ("vertical" === x ? -A : 0)) / 2)
                            : d.lineTo(n + ("horizontal" === x ? t / 2 : 0), q + ((q < h.point.y ? A : -A) + ("vertical" === x ? -A : 0)) / 2),
                        d.stroke());
                }
            }
        ...
        m.prototype.renderLine = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var f = [], l, t = 0; t < a.dataSeriesIndexes.length; t++) {
                    ...
                    var v = h.id;
                    this._eventManager.objectMap[v] = { objectType: "dataSeries", dataSeriesIndex: A };
                    v = Q(v);
                    b.strokeStyle = v;
                        ...
                        for (var C = !1, s = 0; s < p.length; s++)
                            if (((x = p[s].x.getTime ? p[s].x.getTime() : p[s].x), !(x < a.axisX.dataInfo.viewPortMin || (x > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !C)))))
                                if ("number" !== typeof p[s].y) 0 < s && !(h.connectNullData || C || m) && (c.stroke(), w && b.stroke()), (C = !0);
                                    ...
                                    this._eventManager.objectMap[z] = { id: z, objectType: "dataPoint", dataSeriesIndex: A, dataPointIndex: s, x1: x, y1: r };
                                    m || C
                                        ? (!m && h.connectNullData
                                              ? (c.setLineDash &&
                                                ...
                                                c.lineTo(x, r),
                                                w && b.lineTo(x, r))
                                              : (c.beginPath(), c.moveTo(x, r), w && (b.beginPath(), b.moveTo(x, r))),
                                          (C = m = !1))
                                        : (c.lineTo(x, r), w && b.lineTo(x, r), 0 == s % 500 && (c.stroke(), c.beginPath(), c.moveTo(x, r), w && (b.stroke(), b.beginPath(), b.moveTo(x, r))));
                                    l = { x: x, y: r };
                                    s < p.length - 1 &&
                                        (k !== (p[s].lineColor || v) || n !== (p[s].lineDashType || h.lineDashType)) &&
                                        (c.stroke(),
                                        c.beginPath(),
                                        c.moveTo(x, r),
                                        (k = p[s].lineColor || v),
                                        (c.strokeStyle = k),
                                        c.setLineDash && (p[s].lineDashType ? ((n = p[s].lineDashType), c.setLineDash(N(n, h.lineThickness))) : ((n = h.lineDashType), c.setLineDash(g))));
                                    if (0 < p[s].markerSize || 0 < h.markerSize) {
                                        var B = h.getMarkerProperties(s, x, r, c);
                                        f.push(B);
                                        z = Q(z);
                                        w && f.push({ x: x, y: r, ctx: b, type: B.type, size: B.size, color: z, borderColor: z, borderThickness: B.borderThickness });
                                    }
                                    (p[s].indexLabel || h.indexLabel || p[s].indexLabelFormatter || h.indexLabelFormatter) &&
                                        this._indexLabels.push({ chartType: "line", dataPoint: p[s], dataSeries: h, point: { x: x, y: r }, direction: 0 > p[s].y === a.axisY.reversed ? 1 : -1, color: v });
                                }
                        c.stroke();
                        w && b.stroke();
                    }
                        ...
                        for (var C = !1, s = 0; s < p.length; s++)
                            if (((x = p[s].getTime ? p[s].x.getTime() : p[s].x), !(x < a.axisX.dataInfo.viewPortMin || (x > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !C)))))
                                if ("number" !== typeof p[s].y) 0 < s && !(h.connectNullData || C || m) && (c.stroke(), w && b.stroke()), (C = !0);
                                    ...
                                    this._eventManager.objectMap[B] = { id: B, objectType: "dataPoint", dataSeriesIndex: A, dataPointIndex: s, x1: x, y1: r };
                                    m || C
                                        ? (!m && h.connectNullData
                                              ? (c.setLineDash &&
                                                    (h.options.nullDataLineDashType || (n === h.lineDashType && h.lineDashType !== h.nullDataLineDashType)) &&
                                                ...
                                                c.lineTo(x, z),
                                                c.lineTo(x, r),
                                                w && (b.lineTo(x, z), b.lineTo(x, r)))
                                              : (c.beginPath(), c.moveTo(x, r), w && (b.beginPath(), b.moveTo(x, r))),
                                          (C = m = !1))
                                        : (c.lineTo(x, z), w && b.lineTo(x, z), c.lineTo(x, r), w && b.lineTo(x, r), 0 == s % 500 && (c.stroke(), c.beginPath(), c.moveTo(x, r), w && (b.stroke(), b.beginPath(), b.moveTo(x, r))));
                                    l = { x: x, y: r };
                                    s < p.length - 1 &&
                                        (k !== (p[s].lineColor || v) || n !== (p[s].lineDashType || h.lineDashType)) &&
                                        (c.stroke(),
                                        ...
                                        c.setLineDash && (p[s].lineDashType ? ((n = p[s].lineDashType), c.setLineDash(N(n, h.lineThickness))) : ((n = h.lineDashType), c.setLineDash(g))));
                                    if (0 < p[s].markerSize || 0 < h.markerSize)
                                        (z = h.getMarkerProperties(s, x, r, c)), f.push(z), (B = Q(B)), w && f.push({ x: x, y: r, ctx: b, type: z.type, size: z.size, color: B, borderColor: B, borderThickness: z.borderThickness });
                                    (p[s].indexLabel || h.indexLabel || p[s].indexLabelFormatter || h.indexLabelFormatter) &&
                                        this._indexLabels.push({ chartType: "stepLine", dataPoint: p[s], dataSeries: h, point: { x: x, y: r }, direction: 0 > p[s].y === a.axisY.reversed ? 1 : -1, color: v });
                                }
                        c.stroke();
                        w && b.stroke();
                    }
                        ...
                        for (x = !1, m = 0; m < p.length; m++)
                            if (((s = p[m].getTime ? p[m].x.getTime() : p[m].x), !(s < a.axisX.dataInfo.viewPortMin || (s > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !x)))))
                                if ("number" !== typeof p[m].y)
                                    ...
                                    this._eventManager.objectMap[C] = { id: C, objectType: "dataPoint", dataSeriesIndex: A, dataPointIndex: m, x1: s, y1: x };
                                    r[r.length] = { x: s, y: x };
                                    m < p.length - 1 &&
                                        (k !== (p[m].lineColor || v) || n !== (p[m].lineDashType || h.lineDashType)) &&
                                        ((k = p[m].lineColor || v),
                                        (r[r.length - 1].newStrokeStyle = k),
                                        b.setLineDash && (p[m].lineDashType ? ((n = p[m].lineDashType), (r[r.length - 1].newLineDashArray = N(n, h.lineThickness))) : ((n = h.lineDashType), (r[r.length - 1].newLineDashArray = g))));
                                    if (0 < p[m].markerSize || 0 < h.markerSize) {
                                        var z = h.getMarkerProperties(m, s, x, b);
                                        l.push(z);
                                        C = Q(C);
                                        w && l.push({ x: s, y: x, ctx: e, type: z.type, size: z.size, color: C, borderColor: C, borderThickness: z.borderThickness });
                                    }
                                    (p[m].indexLabel || h.indexLabel || p[m].indexLabelFormatter || h.indexLabelFormatter) &&
                                        this._indexLabels.push({ chartType: "spline", dataPoint: p[m], dataSeries: h, point: { x: s, y: x }, direction: 0 > p[m].y === a.axisY.reversed ? 1 : -1, color: v });
                                    x = !1;
                                }
                    d(r);
                }
                    ...
                    if (0 < v.length)
                        for (var k = 5 < n && g.bevelEnabled ? !0 : !1, f = 0; f < v.length; f++)
                            if ((v[f].getTime ? (A = v[f].x.getTime()) : (A = v[f].x), !(A < a.axisX.dataInfo.viewPortMin || A > a.axisX.dataInfo.viewPortMax) && "number" === typeof v[f].y)) {
                                ...
                                b = g.dataPointIds[f];
                                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: f, x1: l, y1: t, x2: m, y2: s };
                                b = Q(b);
                                w && ca(this._eventManager.ghostCtx, l, t, m, s, b, 0, null, !1, !1, !1, !1);
                                (v[f].indexLabel || g.indexLabel || v[f].indexLabelFormatter || g.indexLabelFormatter) &&
                                    this._indexLabels.push({
                                        chartType: "column",
                                        dataPoint: v[f],
                                        dataSeries: g,
                                        point: { x: l + (m - l) / 2, y: 0 > v[f].y === a.axisY.reversed ? t : s },
                                        direction: 0 > v[f].y === a.axisY.reversed ? 1 : -1,
                                        bounds: { x1: l, y1: Math.min(t, s), x2: m, y2: Math.max(t, s) },
                                        color: b,
                                    });
                            }
                }
                        ...
                        for (h = 0; h < s.length; h++)
                            if (((b = s[h].x.getTime ? s[h].x.getTime() : s[h].x), !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof s[h].y)) {
                                ...
                                if (a.axisY.logarithmic || (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < s[h].y))
                                    (t[b] = s[h].y + (t[b] ? t[b] : 0)), 0 < t[b] && ((n = a.axisY.convertValueToPixel(t[b])), (z = "undefined" !== typeof f[b] ? f[b] : q), (f[b] = n));
                                else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= s[h].y)
                                    (A[b] = s[h].y + (A[b] ? A[b] : 0)), (z = a.axisY.convertValueToPixel(A[b])), (n = "undefined" !== typeof l[b] ? l[b] : q), (l[b] = z);
                                ...
                                b = m.dataPointIds[h];
                                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: k, dataPointIndex: h, x1: r, y1: n, x2: C, y2: z };
                                b = Q(b);
                                w && ca(this._eventManager.ghostCtx, r, n, C, z, b, 0, null, !1, !1, !1, !1);
                                (s[h].indexLabel || m.indexLabel || s[h].indexLabelFormatter || m.indexLabelFormatter) &&
                                    this._indexLabels.push({
                                        chartType: "stackedColumn",
                                        dataPoint: s[h],
                                        dataSeries: m,
                                        point: { x: p, y: 0 <= s[h].y ? n : z },
                                        direction: 0 > s[h].y === a.axisY.reversed ? 1 : -1,
                                        bounds: { x1: r, y1: Math.min(n, z), x2: C, y2: Math.max(n, z) },
                                        color: b,
                                    });
                            }
                    }
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var v = 0; v < a.dataSeriesIndexes.length; v++) {
                    var k = a.dataSeriesIndexes[v],
                        ...
                        s = m.dataPoints;
                    if (0 < s.length)
                        for (var x = 5 < g && m.bevelEnabled ? !0 : !1, h = 0; h < s.length; h++)
                            if (((b = s[h].x.getTime ? s[h].x.getTime() : s[h].x), !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof s[h].y)) {
                                p = a.axisX.convertValueToPixel(b);
                                ...
                                if (a.axisY.logarithmic || (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < s[h].y)) {
                                    ...
                                    (A[b] = n + ("undefined" !== typeof A[b] ? A[b] : 0)), (z = a.axisY.convertValueToPixel(A[b])), (n = l[b] ? l[b] : q), (l[b] = z);
                                    ...
                                    f[b] = B + (z - n);
                                } else (B = "undefined" !== typeof l[b] ? l[b] : 0), (z = n + B), (n = q + B), a.dataSeriesIndexes.length - 1 === v && 1 >= Math.abs(e.y2 - z) && (z = e.y2), (l[b] = B + (z - n));
                                b = s[h].color ? s[h].color : m._colorSet[h % m._colorSet.length];
                                ca(c, r, n, C, z, b, 0, null, x && 0 <= s[h].y, 0 > s[h].y && x, !1, !1, m.fillOpacity);
                                b = m.dataPointIds[h];
                                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: k, dataPointIndex: h, x1: r, y1: n, x2: C, y2: z };
                    ...
                    if (0 < v.length) {
                        ...
                        for (f = 0; f < v.length; f++)
                            if ((v[f].getTime ? (A = v[f].x.getTime()) : (A = v[f].x), !(A < a.axisX.dataInfo.viewPortMin || A > a.axisX.dataInfo.viewPortMax) && "number" === typeof v[f].y)) {
                                ...
                                b = g.dataPointIds[f];
                                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: f, x1: s, y1: t, x2: l, y2: m };
                                b = Q(b);
                                ...
                                (v[f].indexLabel || g.indexLabel || v[f].indexLabelFormatter || g.indexLabelFormatter) &&
                                    this._indexLabels.push({
                                        ...
                                        dataPoint: v[f],
                                        dataSeries: g,
                                        point: { x: 0 <= v[f].y ? l : s, y: t + (m - t) / 2 },
                                        direction: 0 > v[f].y === a.axisY.reversed ? 1 : -1,
                                        bounds: { x1: Math.min(s, l), y1: t, x2: Math.max(s, l), y2: m },
                                        color: b,
                                    });
                            }
                    }
                        ...
                        for (h = 0; h < s.length; h++)
                            if (((b = s[h].x.getTime ? s[h].x.getTime() : s[h].x), !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof s[h].y)) {
                                ...
                                var r = (n - (a.plotType.plotUnits.length * g) / 2 + a.index * g) << 0,
                                    ...
                                    z;
                                if (a.axisY.logarithmic || (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < s[h].y))
                                    (t[b] = s[h].y + (t[b] ? t[b] : 0)), 0 < t[b] && ((z = f[b] ? f[b] : q), (f[b] = p = a.axisY.convertValueToPixel(t[b])));
                                ...
                                else if (((p = a.axisY.convertValueToPixel(s[h].y)), 0 <= s[h].y)) {
                                    var B = f[b] ? f[b] : 0;
                                    z = q + B;
                                    p += B;
                                    f[b] = B + (p - z);
                                ...
                                b = m.dataPointIds[h];
                                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: k, dataPointIndex: h, x1: z, y1: r, x2: p, y2: C };
                                b = Q(b);
                                ...
                                (s[h].indexLabel || m.indexLabel || s[h].indexLabelFormatter || m.indexLabelFormatter) &&
                                    this._indexLabels.push({
                                        ...
                                        dataPoint: s[h],
                                        dataSeries: m,
                                        point: { x: 0 <= s[h].y ? p : z, y: n },
                                        direction: 0 > s[h].y === a.axisY.reversed ? 1 : -1,
                                        bounds: { x1: Math.min(z, p), y1: r, x2: Math.max(z, p), y2: C },
                                        color: b,
                                    });
                            }
                    }
                        ...
                        for (h = 0; h < s.length; h++)
                            if (((b = s[h].x.getTime ? s[h].x.getTime() : s[h].x), !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof s[h].y)) {
                                ...
                                if (a.axisY.logarithmic || (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < s[h].y)) {
                                    ...
                                    r = q + B;
                                    p += B;
                                    a.dataSeriesIndexes.length - 1 === v && 1 >= Math.abs(e.x2 - p) && (p = e.x2);
                                    f[b] = B + (p - r);
                                ...
                                b = m.dataPointIds[h];
                                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: k, dataPointIndex: h, x1: r, y1: C, x2: p, y2: z };
                                b = Q(b);
                                ...
                                (s[h].indexLabel || m.indexLabel || s[h].indexLabelFormatter || m.indexLabelFormatter) &&
                                    this._indexLabels.push({
                                        ...
                                        dataPoint: s[h],
                                        dataSeries: m,
                                        point: { x: 0 <= s[h].y ? p : r, y: n },
                                        direction: 0 > s[h].y === a.axisY.reversed ? 1 : -1,
                                        bounds: { x1: Math.min(r, p), y1: C, x2: Math.max(r, p), y2: z },
                                        color: b,
                                    });
                            }
                    }
        ...
        m.prototype.renderArea = function (a) {
            ...
            function b() {
                z &&
                    ...
                    a.axisY.logarithmic || (0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum) ? (C = E) : 0 > a.axisY.viewportMaximum ? (C = t.y1) : 0 < a.axisY.viewportMinimum && (C = E),
                    f.lineTo(m, C),
                    f.lineTo(z.x, C),
                    f.closePath(),
                    ...
                    f.fill(),
                    (f.globalAlpha = 1),
                    w && (l.lineTo(m, C), l.lineTo(z.x, C), l.closePath(), l.fill()),
                    f.beginPath(),
                    f.moveTo(m, s),
                    l.beginPath(),
                    l.moveTo(m, s),
                    ...
                    if (0 < v.length) {
                        ...
                        for (var ja = !0; k < v.length; k++)
                            if (((r = v[k].x.getTime ? v[k].x.getTime() : v[k].x), !(r < a.axisX.dataInfo.viewPortMin || (r > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !ja)))))
                                if ("number" !== typeof v[k].y) g.connectNullData || ja || d || b(), (ja = !0);
                                else {
                                    ...
                                    d || ja
                                        ? (!d && g.connectNullData
                                              ? (f.setLineDash &&
                                                    ...
                                                    ((d = m), (c = s), (m = p.x), (s = p.y), b(), f.moveTo(p.x, p.y), (m = d), (s = c), (z = p), (c = g.nullDataLineDashType), f.setLineDash(S)),
                                                f.lineTo(m, s),
                                                w && l.lineTo(m, s))
                                              : (f.beginPath(), f.moveTo(m, s), w && (l.beginPath(), l.moveTo(m, s)), (z = { x: m, y: s })),
                                          (ja = d = !1))
                                        : (f.lineTo(m, s), w && l.lineTo(m, s), 0 == k % 250 && b());
                                    p = { x: m, y: s };
                                    k < v.length - 1 &&
                                        (y !== (v[k].lineColor || u) || c !== (v[k].lineDashType || g.lineDashType)) &&
                                        (b(),
                                        (y = v[k].lineColor || u),
                                        (f.strokeStyle = y),
                                        f.setLineDash && (v[k].lineDashType ? ((c = v[k].lineDashType), f.setLineDash(N(c, g.lineThickness))) : ((c = g.lineDashType), f.setLineDash(P))));
                                    var aa = g.dataPointIds[k];
                                    this._eventManager.objectMap[aa] = { id: aa, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: k, x1: m, y1: s };
                                    0 !== v[k].markerSize &&
                                        (0 < v[k].markerSize || 0 < g.markerSize) &&
                                        ((r = g.getMarkerProperties(k, m, s, f)), A.push(r), (aa = Q(aa)), w && A.push({ x: m, y: s, ctx: l, type: r.type, size: r.size, color: aa, borderColor: aa, borderThickness: r.borderThickness }));
                                    (v[k].indexLabel || g.indexLabel || v[k].indexLabelFormatter || g.indexLabelFormatter) &&
                                        this._indexLabels.push({ chartType: "area", dataPoint: v[k], dataSeries: g, point: { x: m, y: s }, direction: 0 > v[k].y === a.axisY.reversed ? 1 : -1, color: B });
                                }
                        b();
                        W.drawMarkers(A);
                    }
                            ...
                            if (((g = n[q].x.getTime ? n[q].x.getTime() : n[q].x), !(g < a.axisX.dataInfo.viewPortMin || (g > a.axisX.dataInfo.viewPortMax && (!p.connectNullData || !v)))))
                                if ("number" !== typeof n[q].y)
                                    0 < q &&
                                        !v &&
                                        (p.connectNullData
                                            ? b.setLineDash && 0 < r.length && (p.options.nullDataLineDashType || !n[q - 1].lineDashType) && ((r[r.length - 1].newLineDashArray = y), (B = p.nullDataLineDashType))
                                            : (d(), (r = []))),
                                        (v = !0);
                                else {
                                    ...
                                    this._eventManager.objectMap[S] = { id: S, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: q, x1: g, y1: v };
                                    r[r.length] = { x: g, y: v };
                                    q < n.length - 1 &&
                                        (z !== (n[q].lineColor || C) || B !== (n[q].lineDashType || p.lineDashType)) &&
                                        ((z = n[q].lineColor || C),
                                        (r[r.length - 1].newStrokeStyle = z),
                                        b.setLineDash && (n[q].lineDashType ? ((B = n[q].lineDashType), (r[r.length - 1].newLineDashArray = N(B, p.lineThickness))) : ((B = p.lineDashType), (r[r.length - 1].newLineDashArray = D))));
                                    if (0 !== n[q].markerSize && (0 < n[q].markerSize || 0 < p.markerSize)) {
                                        var P = p.getMarkerProperties(q, g, v, b);
                                        l.push(P);
                                        S = Q(S);
                                        w && l.push({ x: g, y: v, ctx: e, type: P.type, size: P.size, color: S, borderColor: S, borderThickness: P.borderThickness });
                                    }
                                    (n[q].indexLabel || p.indexLabel || n[q].indexLabelFormatter || p.indexLabelFormatter) &&
                                        this._indexLabels.push({ chartType: "splineArea", dataPoint: n[q], dataSeries: p, point: { x: g, y: v }, direction: 0 > n[q].y === a.axisY.reversed ? 1 : -1, color: E });
                                    v = !1;
                                }
                        d();
                        W.drawMarkers(l);
                                      ...
                                      d || c
                                          ? (!d && g.connectNullData
                                                ? (f.setLineDash &&
                                                      ...
                                                      ((d = m), (c = s), (m = p.x), (s = p.y), b(), f.moveTo(p.x, p.y), (m = d), (s = c), (z = p), (S = g.nullDataLineDashType), f.setLineDash(P)),
                                                  f.lineTo(m, aa),
                                                  f.lineTo(m, s),
                                                  w && (l.lineTo(m, aa), l.lineTo(m, s)))
                                                : (f.beginPath(), f.moveTo(m, s), w && (l.beginPath(), l.moveTo(m, s)), (z = { x: m, y: s })),
                                            (c = d = !1))
                                          : (f.lineTo(m, aa), w && l.lineTo(m, aa), f.lineTo(m, s), w && l.lineTo(m, s), 0 == k % 250 && b()),
                                      (p = { x: m, y: s }),
                                      k < v.length - 1 &&
                                          (y !== (v[k].lineColor || u) || S !== (v[k].lineDashType || g.lineDashType)) &&
                                          (b(),
                                          (y = v[k].lineColor || u),
                                          (f.strokeStyle = y),
                                          f.setLineDash && (v[k].lineDashType ? ((S = v[k].lineDashType), f.setLineDash(N(S, g.lineThickness))) : ((S = g.lineDashType), f.setLineDash(D)))),
                                      (r = g.dataPointIds[k]),
                                      (this._eventManager.objectMap[r] = { id: r, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: k, x1: m, y1: s }),
                                      0 !== v[k].markerSize &&
                                          (0 < v[k].markerSize || 0 < g.markerSize) &&
                                          ((aa = g.getMarkerProperties(k, m, s, f)), A.push(aa), (r = Q(r)), w && A.push({ x: m, y: s, ctx: l, type: aa.type, size: aa.size, color: r, borderColor: r, borderThickness: aa.borderThickness })),
                                      (v[k].indexLabel || g.indexLabel || v[k].indexLabelFormatter || g.indexLabelFormatter) &&
                                          this._indexLabels.push({ chartType: "stepArea", dataPoint: v[k], dataSeries: g, point: { x: m, y: s }, direction: 0 > v[k].y === a.axisY.reversed ? 1 : -1, color: B }));
                            }
                        b();
                        W.drawMarkers(A);
                    }
        ...
        m.prototype.renderStackedArea = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (C = 0; C < a.dataSeriesIndexes.length; C++) {
                    z = a.dataSeriesIndexes[C];
                    B = this.data[z];
                    u = B.dataPoints;
                    x = !0;
                    h = [];
                    q = B.id;
                    this._eventManager.objectMap[q] = { objectType: "dataSeries", dataSeriesIndex: z };
                    q = Q(q);
                    r.fillStyle = q;
                    if (0 < p.length) {
                        var e = B._colorSet[0],
                        ...
                        for (var aa = !0, q = 0; q < p.length; q++) {
                            var f = p[q],
                                fa = null,
                                fa = 0 <= B.dataPointIndexes[f] ? u[B.dataPointIndexes[f]] : { x: f, y: null };
                            if (!(f < a.axisX.dataInfo.viewPortMin || (f > a.axisX.dataInfo.viewPortMax && (!B.connectNullData || !aa))))
                                if ("number" !== typeof fa.y) B.connectNullData || aa || x || d(), (aa = !0);
                                    ...
                                    x || aa
                                        ? (!x && B.connectNullData
                                              ? (b.setLineDash &&
                                                    (B.options.nullDataLineDashType || (E === B.lineDashType && B.lineDashType !== B.nullDataLineDashType)) &&
                                                    ((x = h.pop()), (E = h[h.length - 1]), d(), b.moveTo(s.x, s.y), h.push(E), h.push(x), (E = B.nullDataLineDashType), b.setLineDash(P)),
                                                b.lineTo(g, k),
                                                w && r.lineTo(g, k))
                                              : (b.beginPath(), b.moveTo(g, k), w && (r.beginPath(), r.moveTo(g, k))),
                                          (aa = x = !1))
                                        : (b.lineTo(g, k), w && r.lineTo(g, k), 0 == q % 250 && (d(), b.moveTo(g, k), w && r.moveTo(g, k), h.push({ x: g, y: m - ma })));
                                    s = { x: g, y: k };
                                    q < u.length - 1 &&
                                        (S !== (u[q].lineColor || y) || E !== (u[q].lineDashType || B.lineDashType)) &&
                                        (d(),
                                        b.beginPath(),
                                        b.moveTo(g, k),
                                        h.push({ x: g, y: m - ma }),
                                        (S = u[q].lineColor || y),
                                        (b.strokeStyle = S),
                                        b.setLineDash && (u[q].lineDashType ? ((E = u[q].lineDashType), b.setLineDash(N(E, B.lineThickness))) : ((E = B.lineDashType), b.setLineDash(D))));
                                    if (0 <= B.dataPointIndexes[f]) {
                                        var F = B.dataPointIds[B.dataPointIndexes[f]];
                                        this._eventManager.objectMap[F] = { id: F, objectType: "dataPoint", dataSeriesIndex: z, dataPointIndex: B.dataPointIndexes[f], x1: g, y1: k };
                                    }
                                    0 <= B.dataPointIndexes[f] &&
                                        0 !== fa.markerSize &&
                                        (0 < fa.markerSize || 0 < B.markerSize) &&
                                        ((ma = B.getMarkerProperties(B.dataPointIndexes[f], g, k, b)),
                                        l.push(ma),
                                        (f = Q(F)),
                                        w && l.push({ x: g, y: k, ctx: r, type: ma.type, size: ma.size, color: f, borderColor: f, borderThickness: ma.borderThickness }));
                                    (fa.indexLabel || B.indexLabel || fa.indexLabelFormatter || B.indexLabelFormatter) &&
                                        this._indexLabels.push({ chartType: "stackedArea", dataPoint: fa, dataSeries: B, point: { x: g, y: k }, direction: 0 > u[q].y === a.axisY.reversed ? 1 : -1, color: e });
                                }
                        }
                        d();
                        b.moveTo(g, k);
                ...
                for (u = 0; u < a.dataSeriesIndexes.length; u++) {
                    ...
                    if (0 < p.length) {
                        ...
                        for (var aa = !0, q = 0; q < p.length; q++) {
                            var f = p[q],
                                fa = null,
                                fa = 0 <= B.dataPointIndexes[f] ? y[B.dataPointIndexes[f]] : { x: f, y: null };
                            if (!(f < a.axisX.dataInfo.viewPortMin || (f > a.axisX.dataInfo.viewPortMax && (!B.connectNullData || !aa))))
                                    ...
                                    r || aa
                                        ? (!r && B.connectNullData
                                              ? (b.setLineDash &&
                                                    ...
                                                    ((r = h.pop()), (s = h[h.length - 1]), d(), b.moveTo(m.x, m.y), h.push(s), h.push(r), (s = B.nullDataLineDashType), b.setLineDash(P)),
                                                b.lineTo(g, v),
                                                w && E.lineTo(g, v))
                                              : (b.beginPath(), b.moveTo(g, v), w && (E.beginPath(), E.moveTo(g, v))),
                                          (aa = r = !1))
                                        : (b.lineTo(g, v), w && E.lineTo(g, v), 0 == q % 250 && (d(), b.moveTo(g, v), w && E.moveTo(g, v), h.push({ x: g, y: x - ba })));
                                    m = { x: g, y: v };
                                    q < y.length - 1 &&
                                        (S !== (y[q].lineColor || D) || s !== (y[q].lineDashType || B.lineDashType)) &&
                                        (d(),
                                        b.beginPath(),
                                        b.moveTo(g, v),
                                        h.push({ x: g, y: x - ba }),
                                        (S = y[q].lineColor || D),
                                        (b.strokeStyle = S),
                                        b.setLineDash && (y[q].lineDashType ? ((s = y[q].lineDashType), b.setLineDash(N(s, B.lineThickness))) : ((s = B.lineDashType), b.setLineDash(F))));
                                    if (0 <= B.dataPointIndexes[f]) {
                                        var G = B.dataPointIds[B.dataPointIndexes[f]];
                                        this._eventManager.objectMap[G] = { id: G, objectType: "dataPoint", dataSeriesIndex: z, dataPointIndex: B.dataPointIndexes[f], x1: g, y1: v };
                                    }
                                    0 <= B.dataPointIndexes[f] &&
                                        0 !== fa.markerSize &&
                                        (0 < fa.markerSize || 0 < B.markerSize) &&
                                        ((ba = B.getMarkerProperties(q, g, v, b)), t.push(ba), (f = Q(G)), w && t.push({ x: g, y: v, ctx: E, type: ba.type, size: ba.size, color: f, borderColor: f, borderThickness: ba.borderThickness }));
                                    (fa.indexLabel || B.indexLabel || fa.indexLabelFormatter || B.indexLabelFormatter) &&
                                        this._indexLabels.push({ chartType: "stackedArea100", dataPoint: fa, dataSeries: B, point: { x: g, y: v }, direction: 0 > y[q].y === a.axisY.reversed ? 1 : -1, color: e });
                                }
                        }
                        d();
                        b.moveTo(g, v);
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var t = -Infinity, k = Infinity, h = 0; h < a.dataSeriesIndexes.length; h++)
                    for (var p = a.dataSeriesIndexes[h], n = this.data[p], q = n.dataPoints, g = 0, e = 0; e < q.length; e++)
                        (f = q[e].getTime ? (f = q[e].x.getTime()) : (f = q[e].x)), f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax || "undefined" === typeof q[e].z || ((g = q[e].z), g > t && (t = g), g < k && (k = g));
                for (var v = 25 * Math.PI, m = Math.max(Math.pow((0.25 * Math.min(b.height, b.width)) / 2, 2) * Math.PI, v), h = 0; h < a.dataSeriesIndexes.length; h++)
                    if (((p = a.dataSeriesIndexes[h]), (n = this.data[p]), (q = n.dataPoints), 0 < q.length))
                        for (c.strokeStyle = "#4572A7 ", e = 0; e < q.length; e++)
                            if (((f = q[e].getTime ? (f = q[e].x.getTime()) : (f = q[e].x)), !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[e].y)) {
                                ...
                                this._eventManager.objectMap[s] = { id: s, objectType: "dataPoint", dataSeriesIndex: p, dataPointIndex: e, x1: f, y1: l, size: r };
                                r = Q(s);
                        ...
                        for (var n = 0, q = 0, e = 0; e < p.length; e++)
                            if (((f = p[e].getTime ? (f = p[e].x.getTime()) : (f = p[e].x)), !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof p[e].y)) {
                                ...
                                (Math.sqrt((n - f) * (n - f) + (q - l) * (q - l)) < Math.min(g.size, 5) && p.length > Math.min(this.plotArea.width, this.plotArea.height)) ||
                                    ...
                                    (n = Q(n)),
                                    w && W.drawMarker(g.x, g.y, this._eventManager.ghostCtx, g.type, g.size, n, n, g.borderThickness),
                        ...
                        for (var E = 5 < v && s.bevelEnabled ? !0 : !1, t = 0; t < x.length; t++)
                            if (
                                ...
                                var u = (k - v / 2) << 0,
                                    ...
                                    y = 0 === B % 2 ? 0 : 0.5,
                                    D = s.dataPointIds[t];
                                this._eventManager.objectMap[D] = { id: D, objectType: "dataPoint", dataSeriesIndex: ka, dataPointIndex: t, x1: u, y1: h, x2: z, y2: p, x3: k, y3: n, x4: k, y4: q, borderThickness: B, color: e };
                                c.strokeStyle = e;
                                c.beginPath();
                                c.lineWidth = B;
                                ...
                                "candlestick" === s.type
                                    ? (c.moveTo(k - y, p),
                                      c.lineTo(k - y, Math.min(h, q)),
                                      c.stroke(),
                                      c.moveTo(k - y, Math.max(h, q)),
                                      c.lineTo(k - y, n),
                                      c.stroke(),
                                      ca(c, u, Math.min(h, q), z, Math.max(h, q), x[t].y[0] <= x[t].y[3] ? s.risingColor : f, B, e, E, E, !1, !1, s.fillOpacity),
                                      w &&
                                          ((e = Q(D)),
                                          (b.strokeStyle = e),
                                          b.moveTo(k - y, p),
                                          b.lineTo(k - y, Math.min(h, q)),
                                          b.stroke(),
                                          b.moveTo(k - y, Math.max(h, q)),
                                          b.lineTo(k - y, n),
                                          b.stroke(),
                                          ca(b, u, Math.min(h, q), z, Math.max(h, q), e, 0, null, !1, !1, !1, !1)))
                                    : "ohlc" === s.type &&
                                      (c.moveTo(k - y, p),
                                      c.lineTo(k - y, n),
                                      c.stroke(),
                                      ...
                                      w &&
                                          ...
                                          b.lineTo(z, q),
                                          b.stroke()));
                                (x[t].indexLabel || s.indexLabel || x[t].indexLabelFormatter || s.indexLabelFormatter) &&
                                    this._indexLabels.push({
                                        chartType: s.type,
                                        dataPoint: x[t],
                                        dataSeries: s,
                                        point: { x: u + (z - u) / 2, y: a.axisY.reversed ? n : p },
                                        direction: 1,
                                        bounds: { x1: u, y1: Math.min(p, n), x2: z, y2: Math.max(p, n) },
                                        color: e,
                                    });
                            }
                }
                    ...
                    if (0 < E.length)
                        for (var C = 5 < v && x.bevelEnabled ? !0 : !1, l = 0; l < E.length; l++)
                            if (
                                ...
                                c.save();
                                0 < ba &&
                                    (c.beginPath(), (c.strokeStyle = ma), (c.lineWidth = ba), c.setLineDash && c.setLineDash(N(H, ba)), c.moveTo(t - G, h), c.lineTo(t - G, k), c.stroke(), c.moveTo(t - G, n), c.lineTo(t - G, p), c.stroke());
                                c.restore();
                                ...
                                c.stroke();
                                c.save();
                                0 < M && (c.beginPath(), (c.globalAlpha = 1), c.setLineDash && c.setLineDash(N(T, M)), (c.strokeStyle = J), (c.lineWidth = M), c.moveTo(z, q - K), c.lineTo(B, q - K), c.stroke());
                                c.restore();
                                c.save();
                                0 < P &&
                                    (c.beginPath(),
                                    ...
                                    (c.strokeStyle = S),
                                    (c.lineWidth = P),
                                    c.moveTo((t - aa / 2) << 0, n - fa),
                                    c.lineTo((t + aa / 2) << 0, n - fa),
                                    c.stroke(),
                                    c.moveTo((t - aa / 2) << 0, k + fa),
                                    c.lineTo((t + aa / 2) << 0, k + fa),
                                    c.stroke());
                                c.restore();
                                w &&
                                    ((e = Q(O)),
                                    (b.strokeStyle = e),
                                    (b.lineWidth = ba),
                                    0 < ba && (b.moveTo(t - D - G, h), b.lineTo(t - D - G, Math.max(k, n)), b.stroke(), b.moveTo(t - D - G, Math.min(k, n)), b.lineTo(t - D - G, p), b.stroke()),
                                    ca(b, z, Math.max(h, p), B, Math.min(h, p), e, 0, null, !1, !1, !1, !1),
                                    0 < P && (b.beginPath(), (b.lineWidth = P), b.moveTo(t + aa / 2, n - fa), b.lineTo(t - aa / 2, n - fa), b.stroke(), b.moveTo(t + aa / 2, k + fa), b.lineTo(t - aa / 2, k + fa), b.stroke()));
                                (E[l].indexLabel || x.indexLabel || E[l].indexLabelFormatter || x.indexLabelFormatter) &&
                                    this._indexLabels.push({
                                        chartType: x.type,
                                        dataPoint: E[l],
                                        dataSeries: x,
                                        point: { x: z + (B - z) / 2, y: a.axisY.reversed ? k : n },
                                        direction: 1,
                                        bounds: { x1: z, y1: Math.min(k, n), x2: B, y2: Math.max(k, n) },
                                        color: e,
                                    });
                            }
                }
                    ...
                    if (0 < g.length)
                        for (var v = 5 < h && q.bevelEnabled ? !0 : !1, f = 0; f < g.length; f++)
                            if (
                                ...
                                s = q.dataPointIds[f];
                                this._eventManager.objectMap[s] = { id: s, objectType: "dataPoint", dataSeriesIndex: n, dataPointIndex: f, x1: m, y1: l, x2: u, y2: t };
                                ...
                                if (g[f].indexLabel || q.indexLabel || g[f].indexLabelFormatter || q.indexLabelFormatter)
                                    this._indexLabels.push({
                                        ...
                                        dataSeries: q,
                                        indexKeyword: 0,
                                        point: { x: m + (u - m) / 2, y: g[f].y[1] >= g[f].y[0] ? t : l },
                                        direction: g[f].y[1] >= g[f].y[0] ? -1 : 1,
                                        bounds: { x1: m, y1: Math.min(l, t), x2: u, y2: Math.max(l, t) },
                                        color: b,
                                    }),
                                        this._indexLabels.push({
                                            chartType: "rangeColumn",
                                            ...
                                            dataSeries: q,
                                            indexKeyword: 1,
                                            point: { x: m + (u - m) / 2, y: g[f].y[1] >= g[f].y[0] ? l : t },
                                            direction: g[f].y[1] >= g[f].y[0] ? 1 : -1,
                                            bounds: { x1: m, y1: Math.min(l, t), x2: u, y2: Math.max(l, t) },
                                            color: b,
                                        });
        ...
        m.prototype.renderError = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var u = 0, s = 0; s < this.data.length; s++) !this.data[s].type.match(/(bar|column)/gi) || !this.data[s].visible || (this.data[s].type.match(/(stacked)/gi) && u) || u++;
                for (var x = 0; x < a.dataSeriesIndexes.length; x++) {
                    var E = a.dataSeriesIndexes[x],
                        C = this.data[E],
                        z = C.dataPoints,
                        B = r(C._linkedSeries) ? !1 : C._linkedSeries.type.match(/(bar|column)/gi) && C._linkedSeries.visible ? !0 : !1,
                        D = 0;
                    if (B)
                        for (e = C._linkedSeries.id, s = 0; s < e; s++)
                            !this.data[s].type.match(/(bar|column)/gi) || !this.data[s].visible || (this.data[s].type.match(/(stacked)/gi) && D) || (this.data[s].type.match(/(range)/gi) && (f = !0), D++);
                    e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
                    ...
                    f &&
                        (t = this.options.dataPointMaxWidth
                            ...
                            ? this.dataPointWidth
                            : b
                            ? Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / (B ? u : 1))) << 0
                            : 0.03 * this.width);
                    s = this.options.dataPointWidth ? this.dataPointWidth : (0.9 * (((b ? l.height : l.width) * (a.axisX.logarithmic ? Math.log(Fa) / Math.log(a.axisX.range) : Math.abs(Fa) / Math.abs(a.axisX.range))) / (B ? u : 1))) << 0;
                    ...
                    if (0 < z.length)
                        for (var F = C._colorSet, t = 0; t < z.length; t++) {
                            var e = (C.lineColor = C.options.color ? C.options.color : F[0]),
                                S = {
                                    color: z[t].whiskerColor ? z[t].whiskerColor : z[t].color ? (C.whiskerColor ? C.whiskerColor : z[t].color) : C.whiskerColor ? C.whiskerColor : e,
                            ...
                            S.length = "number" === typeof S.length ? (0 >= S.length ? 0 : S.length >= s ? s : S.length) : "string" === typeof S.length ? ((parseInt(S.length) * s) / 100 > s ? s : (parseInt(S.length) * s) / 100 > s) : s;
                            ...
                            if (!(m < a.axisX.dataInfo.viewPortMin || m > a.axisX.dataInfo.viewPortMax) && !r(z[t].y) && z[t].y.length && "number" === typeof z[t].y[0] && "number" === typeof z[t].y[1]) {
                                ...
                                b ? (n = ja) : (g = ja);
                                b
                                    ? ((q = a.axisX.reversed ? (h + ((B ? u : 1) * s) / 2 - (B ? D - 1 : 0) * s) << 0 : (h - ((B ? u : 1) * s) / 2 + (B ? D - 1 : 0) * s) << 0), (g = a.axisX.reversed ? (q - s) << 0 : (q + s) << 0))
                                    : ((p = a.axisX.reversed ? (k + ((B ? u : 1) * s) / 2 - (B ? D - 1 : 0) * s) << 0 : (k - ((B ? u : 1) * s) / 2 + (B ? D - 1 : 0) * s) << 0), (n = a.axisX.reversed ? (p - s) << 0 : (p + s) << 0));
                                !b && q > g && ((ja = q), (q = g), (g = ja));
                                b && p > n && ((ja = p), (p = n), (n = ja));
                                ja = C.dataPointIds[t];
                                ...
                                if (z[t].indexLabel || C.indexLabel || z[t].indexLabelFormatter || C.indexLabelFormatter)
                                    this._indexLabels.push({
                                        chartType: "error",
                                        dataPoint: z[t],
                                        dataSeries: C,
                                        indexKeyword: 0,
                                        point: { x: b ? (z[t].y[1] >= z[t].y[0] ? p : n) : p + (n - p) / 2, y: b ? q + (g - q) / 2 : z[t].y[1] >= z[t].y[0] ? g : q },
                                        ...
                                        this._indexLabels.push({
                                            ...
                                            dataSeries: C,
                                            indexKeyword: 1,
                                            point: { x: b ? (z[t].y[1] >= z[t].y[0] ? n : p) : p + (n - p) / 2, y: b ? q + (g - q) / 2 : z[t].y[1] >= z[t].y[0] ? q : g },
                                            direction: z[t].y[1] >= z[t].y[0] ? 1 : -1,
                                            bounds: { x1: b ? Math.min(p, n) : p, y1: b ? q : Math.min(q, g), x2: b ? Math.max(p, n) : n, y2: b ? g : Math.max(q, g) },
                                            color: e,
                                            axisSwapped: b,
                    ...
                    if (0 < m.length) {
                        ...
                        for (f = 0; f < m.length; f++)
                            if (
                                ...
                                b = g.dataPointIds[f];
                                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: f, x1: l, y1: k, x2: t, y2: u };
                                b = Q(b);
                                ...
                                if (m[f].indexLabel || g.indexLabel || m[f].indexLabelFormatter || g.indexLabelFormatter)
                                    this._indexLabels.push({
                                        ...
                                        dataSeries: g,
                                        indexKeyword: 0,
                                        point: { x: m[f].y[1] >= m[f].y[0] ? l : t, y: k + (u - k) / 2 },
                                        direction: m[f].y[1] >= m[f].y[0] ? -1 : 1,
                                        bounds: { x1: Math.min(l, t), y1: k, x2: Math.max(l, t), y2: u },
                                        color: b,
                                    }),
                                        this._indexLabels.push({
                                            chartType: "rangeBar",
                                            ...
                                            dataSeries: g,
                                            indexKeyword: 1,
                                            point: { x: m[f].y[1] >= m[f].y[0] ? t : l, y: k + (u - k) / 2 },
                                            direction: m[f].y[1] >= m[f].y[0] ? 1 : -1,
                                            bounds: { x1: Math.min(l, t), y1: k, x2: Math.max(l, t), y2: u },
                                            color: b,
                                        });
                ...
                for (var t = 0; t < a.dataSeriesIndexes.length; t++) {
                    ...
                    if (0 < n.length) {
                        ...
                        for (var S = !0; g < n.length; g++)
                            if (((s = n[g].x.getTime ? n[g].x.getTime() : n[g].x), !(s < a.axisX.dataInfo.viewPortMin || (s > a.axisX.dataInfo.viewPortMax && (!p.connectNullData || !S)))))
                                if (null !== n[g].y && n[g].y.length && "number" === typeof n[g].y[0] && "number" === typeof n[g].y[1]) {
                                    ...
                                    q || S
                                        ? (p.connectNullData && !q
                                              ? (b.setLineDash &&
                                                    (p.options.nullDataLineDashType || (B === p.lineDashType && p.lineDashType !== p.nullDataLineDashType)) &&
                                                    ((k[k.length - 1].newLineDashArray = D), (B = p.nullDataLineDashType), b.setLineDash(y)),
                                                b.lineTo(m, r),
                                                w && e.lineTo(m, r),
                                                k.push({ x: m, y1: r, y2: u }))
                                              : (b.beginPath(), b.moveTo(m, r), (x = { x: m, y: r }), (k = []), k.push({ x: m, y1: r, y2: u }), w && (e.beginPath(), e.moveTo(m, r))),
                                          (S = q = !1))
                                        : (b.lineTo(m, r), k.push({ x: m, y1: r, y2: u }), w && e.lineTo(m, r), 0 == g % 250 && d());
                                    s = p.dataPointIds[g];
                                    this._eventManager.objectMap[s] = { id: s, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: g, x1: m, y1: r, y2: u };
                                    g < n.length - 1 &&
                                        (z !== (n[g].lineColor || C) || B !== (n[g].lineDashType || p.lineDashType)) &&
                                        (d(),
                                        (z = n[g].lineColor || C),
                                        (k[k.length - 1].newStrokeStyle = z),
                                        (b.strokeStyle = z),
                                        b.setLineDash &&
                                            (n[g].lineDashType
                                                ? ((B = n[g].lineDashType), (k[k.length - 1].newLineDashArray = N(B, p.lineThickness)), b.setLineDash(k[k.length - 1].newLineDashArray))
                                                : ((B = p.lineDashType), (k[k.length - 1].newLineDashArray = D), b.setLineDash(D))));
                                    if (0 !== n[g].markerSize && (0 < n[g].markerSize || 0 < p.markerSize)) {
                                        var P = p.getMarkerProperties(g, m, u, b);
                                        f.push(P);
                                        var F = Q(s);
                                        w && f.push({ x: m, y: u, ctx: e, type: P.type, size: P.size, color: F, borderColor: F, borderThickness: P.borderThickness });
                                        P = p.getMarkerProperties(g, m, r, b);
                                        f.push(P);
                                        F = Q(s);
                                        w && f.push({ x: m, y: r, ctx: e, type: P.type, size: P.size, color: F, borderColor: F, borderThickness: P.borderThickness });
                                    }
                                    if (n[g].indexLabel || p.indexLabel || n[g].indexLabelFormatter || p.indexLabelFormatter)
                                        this._indexLabels.push({ chartType: "rangeArea", dataPoint: n[g], dataSeries: p, indexKeyword: 0, point: { x: m, y: r }, direction: n[g].y[0] > n[g].y[1] === a.axisY.reversed ? -1 : 1, color: E }),
                                            this._indexLabels.push({
                                                chartType: "rangeArea",
                                                dataPoint: n[g],
                                                dataSeries: p,
                ...
                for (var k = 0; k < a.dataSeriesIndexes.length; k++) {
                    ...
                    if (0 < p.length) {
                        var s = h._colorSet[n % h._colorSet.length],
                            x = (h.lineColor = h.options.lineColor || s),
                            E = x;
                        b.fillStyle = s;
                        b.lineWidth = h.lineThickness;
                        var C = "solid",
                        ...
                        for (g = !1; n < p.length; n++)
                            if (((q = p[n].x.getTime ? p[n].x.getTime() : p[n].x), !(q < a.axisX.dataInfo.viewPortMin || (q > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !g)))))
                                if (null !== p[n].y && p[n].y.length && "number" === typeof p[n].y[0] && "number" === typeof p[n].y[1]) {
                                    ...
                                    this._eventManager.objectMap[y] = { id: y, objectType: "dataPoint", dataSeriesIndex: m, dataPointIndex: n, x1: q, y1: g, y2: v };
                                    r[r.length] = { x: q, y: g };
                                    ka[ka.length] = { x: q, y: v };
                                    n < p.length - 1 &&
                                        (E !== (p[n].lineColor || x) || C !== (p[n].lineDashType || h.lineDashType)) &&
                                        ((E = p[n].lineColor || x),
                                        (r[r.length - 1].newStrokeStyle = E),
                                        b.setLineDash && (p[n].lineDashType ? ((C = p[n].lineDashType), (r[r.length - 1].newLineDashArray = N(C, h.lineThickness))) : ((C = h.lineDashType), (r[r.length - 1].newLineDashArray = z))));
                                    if (0 !== p[n].markerSize && (0 < p[n].markerSize || 0 < h.markerSize)) {
                                        var D = h.getMarkerProperties(n, q, g, b);
                                        f.push(D);
                                        var S = Q(y);
                                        w && f.push({ x: q, y: g, ctx: e, type: D.type, size: D.size, color: S, borderColor: S, borderThickness: D.borderThickness });
                                        D = h.getMarkerProperties(n, q, v, b);
                                        f.push(D);
                                        S = Q(y);
                                        w && f.push({ x: q, y: v, ctx: e, type: D.type, size: D.size, color: S, borderColor: S, borderThickness: D.borderThickness });
                                    }
                                    if (p[n].indexLabel || h.indexLabel || p[n].indexLabelFormatter || h.indexLabelFormatter)
                                        this._indexLabels.push({ chartType: "rangeSplineArea", dataPoint: p[n], dataSeries: h, indexKeyword: 0, point: { x: q, y: g }, direction: p[n].y[0] <= p[n].y[1] ? -1 : 1, color: s }),
                                            this._indexLabels.push({ chartType: "rangeSplineArea", dataPoint: p[n], dataSeries: h, indexKeyword: 1, point: { x: q, y: v }, direction: p[n].y[0] <= p[n].y[1] ? 1 : -1, color: s });
                                    g = !1;
                                } else
                                    0 < n &&
                                        !g &&
                                        (h.connectNullData
                                            ? b.setLineDash && 0 < r.length && (h.options.nullDataLineDashType || !p[n - 1].lineDashType) && ((r[r.length - 1].newLineDashArray = B), (C = h.nullDataLineDashType))
                                            : (d(z, x), (r = []), (ka = []))),
                                        (g = !0);
                        d(z, x);
                        W.drawMarkers(f);
                    ...
                    if (0 < u.length)
                        for (var E = 5 < q && r.bevelEnabled ? !0 : !1, C = !1, z = null, B = null, l = 0; l < u.length; l++)
                            if ((u[l].getTime ? (p = u[l].x.getTime()) : (p = u[l].x), "number" !== typeof u[l].y)) {
                                ...
                                e = r.dataPointIds[l];
                                this._eventManager.objectMap[e] = { id: e, objectType: "dataPoint", dataSeriesIndex: v, dataPointIndex: l, x1: k, y1: m, x2: D, y2: h };
                                ...
                                var P,
                                    S = k;
                                P =
                                    ("undefined" !== typeof u[l].isIntermediateSum && !0 === u[l].isIntermediateSum) || ("undefined" !== typeof u[l].isCumulativeSum && !0 === u[l].isCumulativeSum)
                                        ? 0 < u[l].y
                                            ? m
                                            : h
                                        : 0 < u[l].y
                                ...
                                0 < l &&
                                    z &&
                                    (!C || r.connectNullData) &&
                                    (C && c.setLineDash && c.setLineDash(N(y, s)),
                                    c.beginPath(),
                                    c.moveTo(z, B - x),
                                    c.lineTo(S, P - x),
                                    0 < s && c.stroke(),
                                    w && (b.beginPath(), b.moveTo(z, B - x), b.lineTo(S, P - x), 0 < s && b.stroke()));
                                C = !1;
                                z = D;
                                B = 0 < u[l].y ? m : h;
                                ...
                                (u[l].indexLabel || r.indexLabel || u[l].indexLabelFormatter || r.indexLabelFormatter) &&
                                    this._indexLabels.push({
                                        chartType: "waterfall",
                                        dataPoint: u[l],
                                        dataSeries: r,
                                        point: { x: k + (D - k) / 2, y: 0 <= u[l].y ? m : h },
                                        direction: 0 > u[l].y === a.axisY.reversed ? 1 : -1,
                                        bounds: { x1: k, y1: Math.min(m, h), x2: D, y2: Math.max(m, h) },
                                        color: e,
                                    });
                            }
                }
        ...
        m.prototype.renderPie = function (a) {
            function d() {
                if (h && p) {
                    for (var a = 0, b = 0, c = 0, d = 0, e = 0; e < p.length; e++) {
                        ...
                        if (h.indexLabelFormatter || f.indexLabelFormatter) t = { chart: m.options, dataSeries: h, dataPoint: f, total: n.total, percent: n.percent };
                        ...
                        k.indexLabelBackgroundColor = f.indexLabelBackgroundColor ? f.indexLabelBackgroundColor : h.options.indexLabelBackgroundColor ? h.options.indexLabelBackgroundColor : h.indexLabelBackgroundColor;
                    ...
                    for (e = 0; e < p.length; e++)
                        (k = g[(c + e) % p.length]), 1 < a && k.midAngle > Math.PI / 2 - s && k.midAngle < Math.PI / 2 + s && (f <= a / 2 && !n ? ((k.hemisphere = "right"), f++) : ((k.hemisphere = "left"), (n = !0)));
                    n = !1;
                    for (e = 0; e < p.length; e++)
                        (k = g[(d + e) % p.length]), 1 < b && k.midAngle > (3 * Math.PI) / 2 - s && k.midAngle < (3 * Math.PI) / 2 + s && (l <= b / 2 && !n ? ((k.hemisphere = "left"), l++) : ((k.hemisphere = "right"), (n = !0)));
                }
            }
            function c(a) {
            ...
            function f(a, c, d) {
                ...
                if (0 <= a && a < p.length) {
                    ...
                    var q = 0,
                        ...
                        m = (q = q = 0);
                    0 > c
                        ? n.indexLabelTextBlock.y - n.indexLabelTextBlock.height / 2 > l && n.indexLabelTextBlock.y - n.indexLabelTextBlock.height / 2 + c < l && (c = -(l - (n.indexLabelTextBlock.y - n.indexLabelTextBlock.height / 2 + c)))
                        : n.indexLabelTextBlock.y + n.indexLabelTextBlock.height / 2 < l && n.indexLabelTextBlock.y + n.indexLabelTextBlock.height / 2 + c > k && (c = n.indexLabelTextBlock.y + n.indexLabelTextBlock.height / 2 + c - k);
                    ...
                    for (k = 1; k < p.length; k++)
                        if (((l = (a - k + g.length) % g.length), g[l].hemisphere !== g[a].hemisphere)) {
                            l = null;
                            break;
                        } else if (
                            g[l].indexLabelText &&
                    ...
                    k = l = 0;
                    0 > c
                        ? ((k = "right" === n.hemisphere ? m : q),
                          (h = c),
                          null !== k &&
                              ((m = -c),
                              (c = n.indexLabelTextBlock.y - n.indexLabelTextBlock.height / 2 - (g[k].indexLabelTextBlock.y + g[k].indexLabelTextBlock.height / 2)),
                              c - m < v && ((l = -m), (k = f(k, l, d + 1)), +k.toFixed(x) > +l.toFixed(x) && (h = c > v ? -(c - v) : -(m - (k - l))))))
                        : 0 < c &&
                          ((k = "right" === n.hemisphere ? q : m),
                          (h = c),
                          null !== k &&
                              ((m = c),
                              (c = g[k].indexLabelTextBlock.y - g[k].indexLabelTextBlock.height / 2 - (n.indexLabelTextBlock.y + n.indexLabelTextBlock.height / 2)),
                              c - m < v && ((l = m), (k = f(k, l, d + 1)), +k.toFixed(x) < +l.toFixed(x) && (h = c > v ? c - v : m - (l - k)))));
                    h &&
                        ((d = n.indexLabelTextBlock.y + h),
                        (c = 0),
                        (c = "right" === n.hemisphere ? E.x + Math.sqrt(Math.pow(w, 2) - Math.pow(d - E.y, 2)) : E.x - Math.sqrt(Math.pow(w, 2) - Math.pow(d - E.y, 2))),
                        n.midAngle > Math.PI / 2 - s && n.midAngle < Math.PI / 2 + s
                            ? ((l = (a - 1 + g.length) % g.length),
                              (l = g[l]),
                              (a = g[(a + 1 + g.length) % g.length]),
                              "left" === n.hemisphere && "right" === l.hemisphere && c > l.indexLabelTextBlock.x
                                  ? (c = l.indexLabelTextBlock.x - 15)
                                  : "right" === n.hemisphere && "left" === a.hemisphere && c < a.indexLabelTextBlock.x && (c = a.indexLabelTextBlock.x + 15))
                            : n.midAngle > (3 * Math.PI) / 2 - s &&
                              n.midAngle < (3 * Math.PI) / 2 + s &&
                              ((l = (a - 1 + g.length) % g.length),
                              (l = g[l]),
                              (a = g[(a + 1 + g.length) % g.length]),
                              "right" === n.hemisphere && "left" === l.hemisphere && c < l.indexLabelTextBlock.x
                                  ? (c = l.indexLabelTextBlock.x + 15)
                                  : "left" === n.hemisphere && "right" === a.hemisphere && c > a.indexLabelTextBlock.x && (c = a.indexLabelTextBlock.x - 15)),
                        (n.indexLabelTextBlock.y = d),
                        (n.indexLabelTextBlock.x = c),
                        (n.indexLabelAngle = Math.atan2(n.indexLabelTextBlock.y - E.y, n.indexLabelTextBlock.x - E.x)));
                }
                return h;
            }
            function l() {
                            ...
                            if (null !== s) {
                                ...
                                if (0 > z) {
                                    ...
                                    var y = -1 * (z - r),
                                        H = (C = 0);
                                    "right" === k.hemisphere
                                        ? ((C = f(a, r)), (y = -1 * (z - C)), (H = f(s, y)), +H.toFixed(x) < +y.toFixed(x) && +C.toFixed(x) <= +r.toFixed(x) && f(a, -(y - H)))
                                        : ((C = f(s, r)), (y = -1 * (z - C)), (H = f(a, y)), +H.toFixed(x) < +y.toFixed(x) && +C.toFixed(x) <= +r.toFixed(x) && f(s, -(y - H)));
                                }
                            }
                        }
                    } else
                        for (a = 0; a < p.length; a++)
                            (k = g[a]), (w = "pie" === h.type ? 0.7 * B : 0.8 * B), (s = E.x + w * Math.cos(k.midAngle)), (r = E.y + w * Math.sin(k.midAngle)), (k.indexLabelTextBlock.x = s), (k.indexLabelTextBlock.y = r);
                    for (a = 0; a < p.length; a++)
                        if (((k = g[a]), (s = k.indexLabelTextBlock.measureText()), 0 !== s.height && 0 !== s.width))
                            (s = s = 0),
                                "right" === k.hemisphere ? ((s = q.x2 - (k.indexLabelTextBlock.x + k.indexLabelTextBlock.width + n)), (s *= -1)) : (s = q.x1 - (k.indexLabelTextBlock.x - k.indexLabelTextBlock.width - n)),
                                0 < s &&
                                    (!l &&
                                        k.indexLabelText &&
                                        ((r = "right" === k.hemisphere ? q.x2 - k.indexLabelTextBlock.x : k.indexLabelTextBlock.x - q.x1),
                                        0.3 * k.indexLabelTextBlock.maxWidth > r ? (k.indexLabelText = "") : (k.indexLabelTextBlock.maxWidth = 0.85 * r),
                                        0.3 * k.indexLabelTextBlock.maxWidth < r && (k.indexLabelTextBlock.x -= "right" === k.hemisphere ? 2 : -2)),
                                    Math.abs(k.indexLabelTextBlock.y - k.indexLabelTextBlock.height / 2 - E.y) < B || Math.abs(k.indexLabelTextBlock.y + k.indexLabelTextBlock.height / 2 - E.y) < B) &&
                                    ((s /= Math.abs(Math.cos(k.indexLabelAngle))), 9 < s && (s *= 0.3), s > d && (d = s)),
                                (s = s = 0),
                                0 < k.indexLabelAngle && k.indexLabelAngle < Math.PI
                                    ? ((s = q.y2 - (k.indexLabelTextBlock.y + k.indexLabelTextBlock.height / 2 + 5)), (s *= -1))
                                    : (s = q.y1 - (k.indexLabelTextBlock.y - k.indexLabelTextBlock.height / 2 - 5)),
                                0 < s &&
                                    (!l && k.indexLabelText && ((r = 0 < k.indexLabelAngle && k.indexLabelAngle < Math.PI ? -1 : 1), 0 === f(a, s * r) && f(a, 2 * r)),
                                    Math.abs(k.indexLabelTextBlock.x - E.x) < B && ((s /= Math.abs(Math.sin(k.indexLabelAngle))), 9 < s && (s *= 0.3), s > d && (d = s)));
                        ...
                        for (var a = -1, c = -1, d = 0, f = !1, h = 0; h < p.length; h++)
                            if (((f = !1), (t = g[h]), t.indexLabelText)) {
                                ...
                                if (null !== l) {
                                    ...
                                    q ? (0 > a && (a = h), l !== a && ((c = l), (d += -z)), 0 === h % Math.max(p.length / 10, 3) && (f = !0)) : (f = !0);
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var z = 0; z < p.length; z++)
                    (y += Math.abs(p[z].y)),
                        !a && "undefined" !== typeof p[z].indexLabel && null !== p[z].indexLabel && 0 < p[z].indexLabel.toString().length && (a = !0),
                        !a && "undefined" !== typeof p[z].label && null !== p[z].label && 0 < p[z].label.toString().length && (a = !0);
                if (0 !== y) {
        ...
        m.prototype.renderFunnel = function (a) {
            ...
            function c() {
                ...
                if (0 === g) return -1;
                for (var l = (d[0] = 0), k = 0, n, p, b = b - a, l = !1, h = 0; h < x.length; h++)
                    (a = (Math.abs(x[h].y) * f) / g),
                        l
                            ? (n = 0 == Number(c.toFixed(3)) ? 0 : a / c)
                            : ((p = $ * $ * b * b - 4 * Math.abs($) * a),
                              0 > p
                                  ? ((p = c), (l = ((b + p) * (e - k)) / 2), (a -= l), (n = e - k), (k += e - k), (n += 0 == p ? 0 : a / p), (k += a / p), (l = !0))
                                  : ((n = (Math.abs($) * b - Math.sqrt(p)) / 2),
                                    (p = b - (2 * n) / Math.abs($)),
                                    (k += n),
                                    k > e && ((k -= n), (p = c), (l = ((b + p) * (e - k)) / 2), (a -= l), (n = e - k), (k += e - k), (n += a / p), (k += a / p), (l = !0)),
                                    (b = p))),
                        d.push(n);
                return d;
            }
            function b() {
                if (s && x) {
                    for (var a, b, c, d, e, f, h, l, k, n, p, q, m, t, v = [], A = [], u = { percent: null, total: null }, B = null, z = 0; z < x.length; z++)
                        (t = O[z]), (t = "undefined" !== typeof t.x5 ? (t.y2 + t.y4) / 2 : (t.y2 + t.y3) / 2), (t = g(t).x2 + 1), (v[z] = J - t - V);
                    t = 0.5 * V;
                    for (var z = 0, E = x.length - 1; z < x.length || 0 <= E; z++, E--) {
                        ...
                        d = b.indexLabelBackgroundColor || s.indexLabelBackgroundColor || (w ? "transparent" : null);
                        ...
                        n = "number" === typeof b.indexLabelLineThickness ? b.indexLabelLineThickness : "number" === typeof s.indexLabelLineThickness ? s.indexLabelLineThickness : 2;
                        ...
                        m = s.dataPointIds[z];
                        y._eventManager.objectMap[m] = { id: m, objectType: "dataPoint", dataPointIndex: z, dataSeriesIndex: 0, funnelSection: O[s.reversed ? x.length - 1 - z : z] };
                        "inside" === s.indexLabelPlacement &&
                            ((v[z] = z !== ca ? (s.reversed ? O[z].x2 - O[z].x1 : O[z].x3 - O[z].x4) : O[z].x3 - O[z].x6),
                            20 > v[z] && ((v[z] = z !== ca ? (s.reversed ? O[z].x3 - O[z].x4 : O[z].x2 - O[z].x1) : O[z].x2 - O[z].x1), (v[z] /= 2)));
                        ...
                        if (s.indexLabelFormatter || b.indexLabelFormatter) B = { chart: y.options, dataSeries: s, dataPoint: b, total: u.total, percent: u.percent };
                        b = b.indexLabelFormatter
                            ? b.indexLabelFormatter(B)
                            : b.indexLabel
                            ? y.replaceKeywordsWithValue(b.indexLabel, b, s, z)
                            : s.indexLabelFormatter
                            ? s.indexLabelFormatter(B)
                            : s.indexLabel
                            ? y.replaceKeywordsWithValue(s.indexLabel, b, s, z)
                            : b.label
                            ? b.label
                            : "";
                        0 >= n && (n = 0);
            ...
            function l() {
                ...
                for (var d, e, f, g, h, l, p = 1, m = 0; m < 2 * p; m++) {
                    for (
                        ...
                        (f = I[s]),
                        (g = f.textBlock),
                        (l = (h = q(s) < O.length ? I[q(s)] : null) ? h.textBlock : null),
                        (d = +f.height.toFixed(6)),
                        (e = +g.y.toFixed(6)),
                        !f.isDirty && h && e + d + da > +l.y.toFixed(6) && ((d = g.y + d + da - l.y), (e = a(s, -d)), e < d && (0 < e && (d -= e), (e = a(q(s), d)), e != d)));
                        s--
                    );
                    b();
                }
            ...
            function m(a, b, c) {
                ...
                if (0 === Y.length) l = ga;
                    ...
                    e = (C * (1 != Y.length || (0 != Y[0] && Y[0] != O.length - 1) ? 2 : 1)) / h();
                ...
                a._animator.animate(
                    ...
                    function (c) {
                        ...
                        for (e = 0; e < O.length; e++) qa(d, O[e], s.fillOpacity);
                        u(d);
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                for (
                    var s = this.data[a.dataSeriesIndexes[0]], x = s.dataPoints, E = this.plotArea, C = 0.025 * E.width, z = 0.01 * E.width, B = 0, D = E.height - 2 * C, F = Math.min(E.width - 2 * z, 2.8 * E.height), H = !1, P = 0;
                    P < x.length;
                    P++
                )
                    if (
                        ...
                        (!H && "function" === typeof s.indexLabelFormatter) || "function" === typeof x[P].indexLabelFormatter)
                    )
                        H = !0;
                ...
                if (0 != s.length && s.dataPoints && s.visible && 0 !== x.length) {
                    ...
                    var V = (30 * (J - a)) / 100;
                    "funnel" === s.type
                        ? ((ba = r(s.options.neckHeight) ? 0.35 * D : s.neckHeight),
                          (G = r(s.options.neckWidth) ? 0.25 * a : s.neckWidth),
                          ...
                          ba > D ? (ba = D) : 0 >= ba && (ba = 0),
                          G > a ? (G = a - 0.5) : 0 >= G && (G = 0))
                        : "pyramid" === s.type && ((G = ba = 0), (s.reversed = s.reversed ? !1 : !0));
                    var z = P + a / 2,
                        X = P,
                        Z = P + a,
                        na = s.reversed ? Q : M,
                    ...
                    if (-1 !== P) {
                        if (s.reversed) for (F.push(U), G = P.length - 1; 0 < G; G--) (U += P[G]), F.push(U);
                        else for (G = 0; G < P.length; G++) (U += P[G]), F.push(U);
                        if (s.reversed) for (G = 0; G < P.length; G++) F[G] < xa ? (a.push(K), z.push(W), (ca = G)) : (a.push((F[G] - na + $ * X) / $), z.push((F[G] - na + ea * Z) / ea));
                        else for (G = 0; G < P.length; G++) F[G] < xa ? (a.push((F[G] - na + $ * X) / $), z.push((F[G] - na + ea * Z) / ea), (ca = G)) : (a.push(K), z.push(W));
                        for (G = 0; G < P.length - 1; G++)
                            (U = s.reversed ? (x[x.length - 1 - G].color ? x[x.length - 1 - G].color : s._colorSet[(x.length - 1 - G) % s._colorSet.length]) : x[G].color ? x[G].color : s._colorSet[G % s._colorSet.length]),
                                G === ca
                                    ? O.push({ x1: a[G], y1: F[G], x2: z[G], y2: F[G], x3: W, y3: xa, x4: z[G + 1], y4: F[G + 1], x5: a[G + 1], y5: F[G + 1], x6: K, y6: xa, id: G, height: F[G + 1] - F[G], color: U })
                                    : O.push({ x1: a[G], y1: F[G], x2: z[G], y2: F[G], x3: z[G + 1], y3: F[G + 1], x4: a[G + 1], y4: F[G + 1], id: G, height: F[G + 1] - F[G], color: U });
                        var da = 2,
                            I = [],
                            ha = !1,
                            Y = [],
                        ...
                        a = a = 0;
                        Ca(Y);
                        for (G = 0; G < x.length; G++) x[G].exploded && ((P = !0), s.reversed ? Y.push(x.length - 1 - G) : Y.push(G));
                        ...
                        if (!H)
                            for (G = 0; G < x.length; G++)
                                (B = s.dataPointIds[G]), (a = { id: B, objectType: "dataPoint", dataPointIndex: G, dataSeriesIndex: 0, funnelSection: O[s.reversed ? x.length - 1 - G : G] }), (y._eventManager.objectMap[B] = a);
                        !y.animationEnabled && P ? m(y, -1, 0) : y.animationEnabled && !y.animatedRender && m(y, -1, 0);
                        this.funnelPyramidClickHandler = function (a) {
                            var b = -1;
                            if (!ha && !y.isAnimating && (r(a.dataSeries.explodeOnClick) || a.dataSeries.explodeOnClick) && ((b = s.reversed ? x.length - 1 - a.dataPointIndex : a.dataPointIndex), 0 <= b)) {
                                a = b;
                        ...
                        for (var x = 0; x < n.dataPoints.length; x++) {
                            var y = n.dataPoints[x],
                                ...
                                g = y.legendText
                                    ...
                                    ? this.itemTextFormatter({ chart: this.chart, legend: this.options, dataSeries: n, dataPoint: y })
                                    : y.name
                                    ? y.name
                                    : "DataPoint: " + (x + 1),
                                v = y.legendMarkerColor ? y.legendMarkerColor : n.legendMarkerColor ? n.legendMarkerColor : y.color ? y.color : n.color ? n.color : n._colorSet[x % n._colorSet.length],
                                ...
                                s = y.legendMarkerBorderThickness
                                    ? y.legendMarkerBorderThickness
                                    : n.legendMarkerBorderThickness
                                    ? n.legendMarkerBorderThickness
                                    : y.markerBorderThickness || n.markerBorderThickness
                                    ? Math.max(1, Math.round(0.2 * w))
                                    : 0,
                                g = this.chart.replaceKeywordsWithValue(g, y, n, x),
                                q = { markerType: q, markerColor: v, text: g, textBlock: null, chartType: n.type, markerSize: w, dataSeriesIndex: p, dataPointIndex: x, markerBorderColor: u, markerBorderThickness: s };
                    ...
                    if (!(0 >= l || "undefined" === typeof l || 0 >= u || "undefined" === typeof u)) {
                        if ("horizontal" === this.orientation) {
                            ...
                            if (
                                !n ||
                                n.width +
                                    Math.round(q.textBlock.width + w + k + (0 === n.width ? 0 : this.horizontalSpacing) + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0)) >
                                    f
                            )
                    ...
                    if (q) {
                        switch (this.type) {
                            ...
                            case "bubble":
                                w = q.size;
                                r = Math.sqrt(Math.pow(q.x1 - a, 2) + Math.pow(q.y1 - d, 2));
                                r <= w / 2 && (b.push({ dataPoint: g, dataPointIndex: f, dataSeries: this, distance: r }), (k = !0));
                                break;
                            case "pie":
                            case "doughnut":
                                w = q.center;
                                ...
                                r < q.radius &&
                                    ...
                                    (w = Number(((((180 * (q.startAngle / Math.PI)) % 360) + 360) % 360).toFixed(12))),
                                    (u = Number(((((180 * (q.endAngle / Math.PI)) % 360) + 360) % 360).toFixed(12))),
                                    0 === u && 1 < q.endAngle && (u = 360),
                                    w >= u && 0 !== g.y && ((u += 360), r < w && (r += 360)),
                                    r > w && r < u && (b.push({ dataPoint: g, dataPointIndex: f, dataSeries: this, distance: 0 }), (k = !0)));
                                break;
                            case "funnel":
                            case "pyramid":
                                r = q.funnelSection;
                        ...
                        if (((c = this.logLabelValues[b]), c < this.viewportMinimum)) b++;
                            ...
                            a ||
                                ((a = this.labelFormatter
                                    ...
                                    ? this.labels[p]
                                    : ea(p, this.valueFormatString, this.chart._cultureInfo)),
                                (a = new ia(this.ctx, {
                                    x: 0,
                                    y: 0,
                                    maxWidth: f,
                    ...
                    if (((f = (0.9 * k) >> 0), (q = 0), !this.chart.panEnabled && 1 <= this._labels.length)) {
                        ...
                        for (c = 0; c < this._labels.length; c++)
                            if (!this._labels[c].breaksLabelType) {
                                ...
                                for (var u, g = a.text.split(" "), b = 0; b < g.length; b++)
                                    (p = g[b]), (this.ctx.font = a.fontStyle + " " + a.fontWeight + " " + a.fontSize + "px " + a.fontFamily), (p = this.ctx.measureText(p)), p.width > q && ((u = c), (q = p.width));
                            }
                        c = 0;
                                    ...
                                    if (
                                        ...
                                        this.labelWrap
                                            ? r(this.options.labelMaxWidth)
                                                ? ((this.sessionVariables.labelMaxWidth = Math.min(Math.max(f, q), p)),
                                                  (this.sessionVariables.labelWrap = this.labelWrap),
                                                  d && (v.width + d.width) >> 0 > 2 * f && (this.sessionVariables.labelAngle = -25))
                                                : ((this.sessionVariables.labelWrap = this.labelWrap),
                                            ...
                                            ? ((this.sessionVariables.labelWrap = this.labelWrap),
                                              (this.sessionVariables.labelMaxHeight = l),
                                              (this.sessionVariables.labelMaxWidth = f),
                                              d && (v.width + d.width) >> 0 > 2 * f && ((this.sessionVariables.labelAngle = -25), (this.sessionVariables.labelMaxWidth = p)))
                                            : ((this.sessionVariables.labelAngle = this.sessionVariables.labelMaxWidth > f ? -25 : this.sessionVariables.labelAngle),
                                              (this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth),
                                              (this.sessionVariables.labelMaxHeight = l),
                                              (this.sessionVariables.labelWrap = this.labelWrap));
                                        ...
                                        if (r(this.options.labelWrap))
                                            if (!r(this.options.labelMaxWidth))
                                                ...
                                                if (((b = (v.width + d.width) >> 0), (g = this.labelFontSize), q < f))
                                                    b - 2 * f > n &&
                                                        ((n = b - 2 * f),
                                                        b >= 2 * f && b < 2.2 * f
                                                            ? ((this.sessionVariables.labelMaxWidth = f),
                                                    ...
                                                    u === c &&
                                                    ((0 === u && q + this._labels[u + 1].textBlock.measureText().width - 2 * f > n) ||
                                                        (u === this._labels.length - 1 && q + this._labels[u - 1].textBlock.measureText().width - 2 * f > n) ||
                                                        (0 < u && u < this._labels.length - 1 && q + this._labels[u + 1].textBlock.measureText().width - 2 * f > n && q + this._labels[u - 1].textBlock.measureText().width - 2 * f > n))
                                                )
                                                    (n = 0 === u ? q + this._labels[u + 1].textBlock.measureText().width - 2 * f : q + this._labels[u - 1].textBlock.measureText().width - 2 * f),
                                                        (this.sessionVariables.labelFontSize = r(this.options.labelFontSize) ? g : this.options.labelFontSize),
                                                        (this.sessionVariables.labelWrap = !0),
                                                        (this.sessionVariables.labelAngle = -25),
                                                        (this.sessionVariables.labelMaxWidth = p);
                                                    ...
                                                    for (this.sessionVariables.labelFontSize = r(this.options.labelFontSize) ? g : this.options.labelFontSize, this.sessionVariables.labelWrap = !0, b = 0; b < this._labels.length; b++)
                                                        (a = this._labels[b].textBlock),
                                                            ...
                                                            b < this._labels.length - 1 &&
                                                                ...
                                                                (d = d.measureText()),
                                                                (v.width + d.width) >> 0 > 2 * f && (this.sessionVariables.labelAngle = -25));
                                    }
                                else
                                    ((this.sessionVariables.labelAngle = this.labelAngle),
            ...
            for (c = 0; c < this.stripLines.length; c++) {
                ...
                if ("outside" === f.labelPlacement) {
                    ...
                    (l = "bottom" === this._position || "top" === this._position ? (0.9 * this.chart.width) >> 0 : (0.9 * this.chart.height) >> 0),
                        (y = r(f.options.labelWrap) || f.labelWrap ? ("bottom" === this._position || "top" === this._position ? (0.8 * this.chart.width) >> 0 : (0.8 * this.chart.height) >> 0) : 1.5 * this.labelFontSize),
        ...
        D.setLayout = function (a, d, c, b, e, f) {
            ...
            for (g = 0; g < q.length; g++)
                if (q[g] && q[g].scaleBreaks && q[g].scaleBreaks._appliedBreaks.length)
                    for (var v = q[g].scaleBreaks._appliedBreaks, w = 0; w < v.length && !(v[w].startValue > q[g].viewportMaximum); w++)
                        v[w].endValue < q[g].viewportMinimum || (r(q[g].scaleBreaks.firstBreakIndex) && (q[g].scaleBreaks.firstBreakIndex = w), v[w].startValue >= q[g].viewPortMinimum && (q[g].scaleBreaks.lastBreakIndex = w));
            for (var u = (w = 0), s = 0, x = 0, y = 0, C = 0, z = 0, B, D, F = (k = 0), H, J, L, v = (H = J = L = !1), g = 0; g < q.length; g++)
                q[g] &&
                    q[g].title &&
            ...
            if ("normal" === e) {
                for (var x = [], y = [], C = [], z = [], M = [], N = [], Q = [], R = []; 4 > w; ) {
                    var G = 0,
                        ...
                        O = 0,
                        $ = 0;
                    if (c && 0 < c.length) for (C = [], g = O = 0; g < c.length; g++) C.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateWidth() : 0)), (O += C[g]), (K += c[g] && !p.isNavigator ? c[g].margin : 0);
                    else C.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateWidth() : 0));
                    Q.push(C);
                    if (b && 0 < b.length) for (z = [], g = $ = 0; g < b.length; g++) z.push(Math.ceil(b[g] ? b[g].createLabelsAndCalculateWidth() : 0)), ($ += z[g]), (Z += b[g] ? b[g].margin : 0);
                    ...
                    if (d && 0 < d.length)
                        for (y = [], g = W = 0; g < d.length; g++)
                            d[g] && (d[g].lineCoordinates = {}),
                                ...
                                (W += y[g]),
                                (X += d[g] && !p.isNavigator ? d[g].margin : 0);
                        ...
                        for (g = 0; g < a.length; g++)
                            a[g] &&
                                ...
                                a[g]._labels &&
                                    ...
                                    (u = h.textBlock.width * Math.cos((Math.PI / 180) * Math.abs(h.textBlock.angle)) + (h.textBlock.height - k.textBlock.fontSize / 2) * Math.sin((Math.PI / 180) * Math.abs(h.textBlock.angle))),
                                    (s = k.textBlock.width * Math.cos((Math.PI / 180) * Math.abs(k.textBlock.angle)) + (k.textBlock.height - k.textBlock.fontSize / 2) * Math.sin((Math.PI / 180) * Math.abs(k.textBlock.angle)))),
                                !a[g] ||
                                    !a[g].labelAutoFit ||
                                    r(B) ||
                                    r(D) ||
                                    ...
                                    ((k = 0),
                                    0 < a[g].labelAngle
                                        ? D + s > m && (k += 0 < a[g].labelAngle ? D + s - m - $ : 0)
                                        : 0 > a[g].labelAngle
                                        ? B - u < l && B - u < a[g].viewportMinimum && (F = l - (K + a[g].tickLength + C + B - u + a[g].labelFontSize / 2))
                                        : 0 === a[g].labelAngle && (D + s > m && (k = D + s / 2 - m - $), B - u < l && B - u < a[g].viewportMinimum && (F = l - K - a[g].tickLength - C - B + u / 2)),
                                    a[g].viewportMaximum === a[g].maximum && a[g].viewportMinimum === a[g].minimum && 0 < a[g].labelAngle && 0 < k
                                        ...
                                        ? (l += F)
                                        : a[g].viewportMaximum === a[g].maximum && a[g].viewportMinimum === a[g].minimum && 0 === a[g].labelAngle && (0 < F && (l += F), 0 < k && (m -= k))),
                                p.panEnabled ? (U = r(p.sessionVariables.axisX.height) ? (p.sessionVariables.axisX.height = U) : p.sessionVariables.axisX.height) : (p.sessionVariables.axisX.height = U),
                                (k = Math.round(f.y2 - U - e + G)),
                                (h = Math.round(f.y2)),
                                ...
                                (a[g].bounds = { x1: l, y1: k, x2: m, y2: h - (U + e - x[g] - G), width: m - l, height: h - k })),
                                (G += x[g] + a[g].margin);
                    if (d && 0 < d.length)
                        for (g = 0; g < d.length; g++)
                            (d[g].lineCoordinates.x1 = Math.round(f.x1 + O + K)),
                                (d[g].lineCoordinates.x2 = Math.round(f.x2 - $ - Z > p.width - n ? p.width - n : f.x2 - $ - Z)),
                                (d[g].lineCoordinates.width = Math.abs(m - l)),
                                d[g]._labels &&
                                    ...
                                    (u = h.textBlock.width * Math.cos((Math.PI / 180) * Math.abs(h.textBlock.angle)) + (h.textBlock.height - k.textBlock.fontSize / 2) * Math.sin((Math.PI / 180) * Math.abs(h.textBlock.angle))),
                                    (s = k.textBlock.width * Math.cos((Math.PI / 180) * Math.abs(k.textBlock.angle)) + (k.textBlock.height - k.textBlock.fontSize / 2) * Math.sin((Math.PI / 180) * Math.abs(k.textBlock.angle)))),
                                p.panEnabled ? (W = r(p.sessionVariables.axisX2.height) ? (p.sessionVariables.axisX2.height = W) : p.sessionVariables.axisX2.height) : (p.sessionVariables.axisX2.height = W),
                                (k = Math.round(f.y1)),
                                (h = Math.round(f.y2 + d[g].margin)),
                                (d[g].lineCoordinates.y1 = k + W + X - T),
                                ...
                                (d[g].bounds = { x1: l, y1: k + (W + X - y[g] - T), x2: m, y2: h, width: m - l, height: h - k }),
                                (T += y[g] + d[g].margin);
                    if (c && 0 < c.length)
                        for (g = 0; g < c.length; g++)
                            (K = p.isNavigator ? 0 : 10),
                                c[g] &&
                                    ...
                                    (K = c[g]._labels && 0 < c[g]._labels.length ? c[g]._labels[c[g]._labels.length - 1].textBlock.height / 2 : n),
                                    (k = Math.round(f.y1 + W + X < Math.max(K, n) ? Math.max(K, n) : f.y1 + W + X)),
                                    (m = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1)),
                                    (K = 0 < a.length ? 0 : c[g]._labels && 0 < c[g]._labels.length ? c[g]._labels[0].textBlock.height / 2 : n),
                                    (h = Math.round(f.y2 - U - e - K)),
                                    (c[g].lineCoordinates = { x1: l - V, y1: k, x2: m - V, y2: h, height: Math.abs(h - k) }),
                                    "inside" === c[g].labelPlacement &&
                                        0 < g &&
                                        ((c[g].lineCoordinates.x1 = c[g].lineCoordinates.x1 - (C[g] - c[g]._titleTextBlock ? c[g]._titleTextBlock.height : 0) + ("outside" === c[g].tickPlacement ? c[g].tickLength : 0)),
                                        (c[g].lineCoordinates.x2 = c[g].lineCoordinates.x1 + c[g].lineThickness / 2)),
                                    (c[g].bounds = { x1: l - (C[g] + V), y1: k, x2: m, y2: h, width: m - l, height: h - k }),
                    ...
                    if (b && 0 < b.length)
                        for (g = 0; g < b.length; g++)
                            b[g] &&
                                ...
                                (h = Math.round(f.y2 - (U + e + K))),
                                (b[g].lineCoordinates = { x1: l + Y, y1: k, x2: l + Y, y2: h, height: Math.abs(h - k) }),
                                "inside" === b[g].labelPlacement &&
                                    0 < g &&
                                    ((b[g].lineCoordinates.x1 = b[g].lineCoordinates.x1 + (z[g] - b[g]._titleTextBlock ? b[g]._titleTextBlock.height : 0) - ("outside" === b[g].tickPlacement ? b[g].tickLength : 0) - 2),
                                    (b[g].lineCoordinates.x2 = b[g].lineCoordinates.x1 + b[g].lineThickness / 2)),
                                (b[g].bounds = { x1: l, y1: k, x2: m + (z[g] + Y), y2: h, width: m - l, height: h - k }),
                    ...
                    if (0 < w) {
                        if (a && 0 < a.length) for (g = 0; g < a.length; g++) v = M[w - 1][g] === M[w][g] ? !0 : !1;
                        else v = !0;
                        if (d && 0 < d.length) for (g = 0; g < d.length; g++) H = N[w - 1][g] === N[w][g] ? !0 : !1;
                        else H = !0;
                        if (c && 0 < c.length) for (g = 0; g < c.length; g++) J = Q[w - 1][g] === Q[w][g] ? !0 : !1;
                        else J = !0;
                        if (b && 0 < b.length) for (g = 0; g < b.length; g++) L = R[w - 1][g] === R[w][g] ? !0 : !1;
                        else L = !0;
                    }
                    if (v && H && J && L) break;
                    w++;
                ...
                for (N = []; 4 > w; ) {
                    ...
                    if (a && 0 < a.length) for (F = [], g = Y = 0; g < a.length; g++) F.push(Math.ceil(a[g] ? a[g].createLabelsAndCalculateWidth() : 0)), (Y += F[g]), (e += a[g] && !p.isNavigator ? a[g].margin : 0);
                    else F.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateWidth() : 0));
                    M.push(F);
                    if (d && 0 < d.length) for (u = [], g = U = 0; g < d.length; g++) u.push(Math.ceil(d[g] ? d[g].createLabelsAndCalculateWidth() : 0)), (U += u[g]), (X += d[g] ? d[g].margin : 0);
                    else u.push(Math.ceil(d[0] ? d[0].createLabelsAndCalculateWidth() : 0));
                    N.push(u);
                    if (c && 0 < c.length)
                        for (g = 0; g < c.length; g++)
                            (c[g].lineCoordinates = {}),
                                (l = Math.round(f.x1 + Y + e)),
                                (m = Math.round(f.x2 - U - X > p.width - 10 ? p.width - 10 : f.x2 - U - X)),
                                c[g].labelAutoFit &&
                                    !r(x) &&
                    ...
                    if (b && 0 < b.length)
                        for (g = 0; g < b.length; g++)
                            (b[g].lineCoordinates = {}),
                                ...
                                b[g] && b[g].labelAutoFit && !r(C) && (0 < !a.length && (l = 0 < b[g].labelAngle ? Math.max(l, C) : 0 === b[g].labelAngle ? Math.max(l, C / 2) : l), 0 < !d.length && (m -= z / 2)),
                    ...
                    if (c && 0 < c.length) for (n = [], g = V = 0; g < c.length; g++) n.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateHeight() : 0)), (V += n[g] + c[g].margin), (K += c[g].margin);
                    else n.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateHeight() : 0));
                    D.push(n);
                    if (b && 0 < b.length) for (B = [], g = T = 0; g < b.length; g++) B.push(Math.ceil(b[g] ? b[g].createLabelsAndCalculateHeight() : 0)), (T += B[g]), (Z += b[g].margin);
                    ...
                    if (c && 0 < c.length)
                        for (g = 0; g < c.length; g++)
                            0 < c[g]._labels.length &&
                                ...
                                (y = k.textBlock.width * Math.cos((Math.PI / 180) * Math.abs(k.textBlock.angle)) + (k.textBlock.height - k.textBlock.fontSize / 2) * Math.sin((Math.PI / 180) * Math.abs(k.textBlock.angle))));
                    if (b && 0 < b.length)
                        for (g = 0; g < b.length; g++)
                            b[g] &&
                                ...
                                (C = h.textBlock.width * Math.cos((Math.PI / 180) * Math.abs(h.textBlock.angle)) + (h.textBlock.height - k.textBlock.fontSize / 2) * Math.sin((Math.PI / 180) * Math.abs(h.textBlock.angle))),
                                (z = k.textBlock.width * Math.cos((Math.PI / 180) * Math.abs(k.textBlock.angle)) + (k.textBlock.height - k.textBlock.fontSize / 2) * Math.sin((Math.PI / 180) * Math.abs(k.textBlock.angle))));
                    ...
                    if (c && 0 < c.length)
                        for (g = c.length - 1; 0 <= g; g--)
                            (k = Math.round(f.y2)),
                                ...
                                (c[g].lineCoordinates.y1 = k - (n[g] + c[g].margin + W)),
                                (c[g].lineCoordinates.y2 = k - (n[g] + c[g].margin + W)),
                                "inside" === c[g].labelPlacement &&
                                    0 < g &&
                                ...
                                (c[g].bounds = { x1: l, y1: k - (n[g] + W + c[g].margin), x2: m, y2: h - (W + c[g].margin), width: m - l, height: n[g] }),
                                c[g].title && (c[g]._titleTextBlock.maxWidth = 0 < c[g].titleMaxWidth && c[g].titleMaxWidth < c[g].lineCoordinates.width ? c[g].titleMaxWidth : c[g].lineCoordinates.width),
                                (W += n[g] + c[g].margin);
                    if (b && 0 < b.length)
                        for (g = b.length - 1; 0 <= g; g--)
                            b[g] &&
                                ...
                                "inside" === b[g].labelPlacement && 0 < g && (b[g].lineCoordinates.y1 = h - B[g] + (b[g]._titleTextBlock ? b[g]._titleTextBlock.height : 0)),
                                (b[g].bounds = { x1: l, y1: k + (b[g].margin + G), x2: m, y2: h, width: m - l, height: T }),
                                b[g].title && (b[g]._titleTextBlock.maxWidth = 0 < b[g].titleMaxWidth && b[g].titleMaxWidth < b[g].lineCoordinates.width ? b[g].titleMaxWidth : b[g].lineCoordinates.width),
                                (G += B[g] + b[g].margin));
                    if (a && 0 < a.length)
                        for (g = 0; g < a.length; g++) {
                            ...
                            h =
                                c && 0 < c.length
                                    ? Math.round(c[0] ? c[0].lineCoordinates.y1 : f.y2 - V > p.height - Math.max(K, 10) ? p.height - Math.max(K, 10) : f.y2 - V)
                                    : f.y2 > p.height - Math.max(K, 10)
                            ...
                            a[g].lineCoordinates = { x1: m - Q, y1: k, x2: m - Q, y2: h, height: Math.abs(h - k) };
                            "inside" === a[g].labelPlacement &&
                                0 < g &&
                            ...
                            a[g].bounds = { x1: m - (F[g] + Q), y1: k, x2: m, y2: h, width: m - l, height: h - k };
                    ...
                    if (d && 0 < d.length)
                        for (g = 0; g < d.length; g++) {
                            ...
                            d[g].lineCoordinates = { x1: m + R, y1: k, x2: m + R, y2: h, height: Math.abs(h - k) };
                            "inside" === d[g].labelPlacement &&
                                0 < g &&
                                ((d[g].lineCoordinates.x1 = d[g].lineCoordinates.x1 + (u[g] - (d[g]._titleTextBlock ? d[g]._titleTextBlock.height : 0) - 2) - ("outside" === d[g].tickPlacement ? d[g].tickLength : 0)),
                                (d[g].lineCoordinates.x2 = d[g].lineCoordinates.x1 + d[g].lineThickness / 2));
                            d[g].bounds = { x1: d[g].lineCoordinates.x1, y1: k, x2: m + u[g] + R, y2: h, width: m - l, height: h - k };
                    ...
                    if (0 < w) {
                        ...
                        if (c && 0 < c.length) for (g = 0; g < c.length; g++) J = D[w - 1][g] === D[w][g] ? !0 : !1;
                        else J = !0;
                        if (b && 0 < b.length) for (g = 0; g < b.length; g++) L = s[w - 1][g] === s[w][g] ? !0 : !1;
                        else L = !0;
                    }
                    if (v && H && J && L) break;
                    w++;
        ...
        M.prototype.render = function () {
            ...
            if (0 < d) {
                ...
                if ("bottom" === this.parent._position || "top" === this.parent._position)
                    (e = f = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0), (k = this.chart.plotArea.y1), (m = this.chart.plotArea.y2), (this.bounds = { x1: e - d / 2, y1: k, x2: f + d / 2, y2: m });
                else if ("left" === this.parent._position || "right" === this.parent._position)
                    (k = m = 1 === this.ctx.lineWidth % 2 ? (a.y << 0) + 0.5 : a.y << 0), (e = this.chart.plotArea.x1), (f = this.chart.plotArea.x2), (this.bounds = { x1: e, y1: k - d / 2, x2: f, y2: m + d / 2 });
                this.ctx.moveTo(e, k);
                this.ctx.lineTo(f, m);
                this.ctx.stroke();
        ...
        $.prototype.render = function (a, d, c) {
            ...
            if (this.snapToDataPoint) {
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    var u = null;
                    if ("bottom" === this.parent._position || "top" === this.parent._position) v = this.parent.dataSeries[0].axisX.convertPixelToValue({ y: d });
                    else if ("left" === this.parent._position || "right" === this.parent._position) v = this.parent.convertPixelToValue({ y: d });
                    for (var y = 0; y < this.parent.dataSeries.length; y++)
                        (u = this.parent.dataSeries[y].getDataPointAtX(v, !0)) && 0 <= u.index && ((u.dataSeries = this.parent.dataSeries[y]), null !== u.dataPoint.y && u.dataSeries.visible && p.push(u));
                    u = null;
                    ...
                    if ("rangeBar" === p[0].dataSeries.type || "error" === p[0].dataSeries.type)
                        for (var u = Math.abs(a - this.parent.convertValueToPixel(p[y].dataPoint.y[0])), s = 0, v = 0; v < p.length; v++)
                            if (p[v].dataPoint.y && p[v].dataPoint.y.length) for (var x = 0; x < p[v].dataPoint.y.length; x++) (s = Math.abs(a - this.parent.convertValueToPixel(p[v].dataPoint.y[x]))), s < u && ((u = s), (y = v));
                        ...
                        for (var u = Math.abs(a - this.parent.convertValueToPixel(p[0].dataPoint.y)), E = (s = 0), v = (y = 0); v < p.length; v++)
                            if (p[v].dataPoint.y && p[v].dataPoint.y.length) for (x = 0; x < p[v].dataPoint.y.length; x++) (s = Math.abs(a - this.parent.convertValueToPixel(p[v].dataPoint.y[x]))), s < u && ((u = s), (y = v));
                        ...
                        for (var u = Math.abs(a - this.parent.convertValueToPixel(p[0].dataPoint.y)), C = (E = s = 0), v = 0; v < p.length; v++)
                            if (p[v].dataPoint.y && p[v].dataPoint.y.length) for (x = 0; x < p[v].dataPoint.y.length; x++) (s = Math.abs(a - this.parent.convertValueToPixel(p[v].dataPoint.y[x]))), s < u && ((u = s), (y = v));
                            else
                                (E += p[v].dataPoint.y),
                                    (C = p[v].dataPoint.x.getTime ? p[v].dataPoint.x.getTime() : p[v].dataPoint.x),
                                    (C = 100 * (E / p[v].dataSeries.plotUnit.dataPointYSums[C])),
                                    (s = Math.abs(a - this.parent.convertValueToPixel(C))),
                                    s < u && ((u = s), (y = v));
                    else
                        for (u = Math.abs(a - this.parent.convertValueToPixel(p[0].dataPoint.y)), v = y = s = 0; v < p.length; v++)
                            if (p[v].dataPoint.y && p[v].dataPoint.y.length) for (x = 0; x < p[v].dataPoint.y.length; x++) (s = Math.abs(a - this.parent.convertValueToPixel(p[v].dataPoint.y[x]))), s < u && ((u = s), (y = v));
                            else (s = Math.abs(a - this.parent.convertValueToPixel(p[v].dataPoint.y))), s < u && ((u = s), (y = v));
                    x = p[y];
                    if ("bottom" === this.parent._position || "top" === this.parent._position) {
                        ...
                        if ("rangeBar" === this.parent.dataSeries[y].type || "error" === this.parent.dataSeries[y].type) {
                            ...
                            this.value = C;
                            h.text = this.labelFormatter
                                ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: c ? c : C })
                                : r(this.options.label)
                                ? ea(c ? c : C, this.valueFormatString, this.chart._cultureInfo)
                                : this.label;
                        } else
                            (m = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(x.dataPoint.y) << 0) + 0.5 : this.parent.convertValueToPixel(x.dataPoint.y) << 0),
                        ...
                        this.bounds = { x1: b - n / 2, y1: f, x2: e + n / 2, y2: k };
                        ...
                        this.bounds = { x1: b, y1: f - n / 2, x2: e, y2: k + n / 2 };
                        C = !1;
                        ...
                        if (C) {
                            if ("axisX" === this.parent.type)
                                for (v = this.parent.convertPixelToValue({ y: d }), u = null, y = 0; y < this.parent.dataSeries.length; y++)
                                    (u = this.parent.dataSeries[y].getDataPointAtX(v, !0)) &&
                                        0 <= u.index &&
                                        (h.text = this.labelFormatter
                    ...
                    if (C) {
                        if ("axisX" === this.parent.type)
                            for (v = this.parent.convertPixelToValue({ x: a }), u = null, y = 0; y < this.parent.dataSeries.length; y++)
                                (u = this.parent.dataSeries[y].getDataPointAtX(v, !0)) &&
                                    0 <= u.index &&
                                    (h.text = this.labelFormatter
                                        ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: x.dataPoint.x })
                    ...
                    !r(this.parent.dataSeries) && 0 < this.parent.dataSeries.length && (v = this.parent.dataSeries[0].axisX.convertPixelToValue({ x: a }));
                    for (y = 0; y < this.parent.dataSeries.length; y++)
                        (u = this.parent.dataSeries[y].getDataPointAtX(v, !0)) && 0 <= u.index && ((u.dataSeries = this.parent.dataSeries[y]), null !== u.dataPoint.y && u.dataSeries.visible && p.push(u));
                    if (0 === p.length) return;
                    p.sort(function (a, b) {
                    ...
                    if (
                        ...
                        for (u = Math.abs(d - this.parent.convertValueToPixel(p[0].dataPoint.y[0])), v = s = 0; v < p.length; v++)
                            if (p[v].dataPoint.y && p[v].dataPoint.y.length) for (x = 0; x < p[v].dataPoint.y.length; x++) (s = Math.abs(d - this.parent.convertValueToPixel(p[v].dataPoint.y[x]))), s < u && ((u = s), (y = v));
                        ...
                        for (u = Math.abs(d - this.parent.convertValueToPixel(p[0].dataPoint.y)), v = E = s = 0; v < p.length; v++)
                            if (p[v].dataPoint.y && p[v].dataPoint.y.length) for (x = 0; x < p[v].dataPoint.y.length; x++) (s = Math.abs(d - this.parent.convertValueToPixel(p[v].dataPoint.y[x]))), s < u && ((u = s), (y = v));
                        ...
                        for (u = Math.abs(d - this.parent.convertValueToPixel(p[0].dataPoint.y)), v = C = E = s = 0; v < p.length; v++)
                            if (p[v].dataPoint.y && p[v].dataPoint.y.length) for (x = 0; x < p[v].dataPoint.y.length; x++) (s = Math.abs(d - this.parent.convertValueToPixel(p[v].dataPoint.y[x]))), s < u && ((u = s), (y = v));
                                ...
                                (E += p[v].dataPoint.y),
                                    (C = p[v].dataPoint.x.getTime ? p[v].dataPoint.x.getTime() : p[v].dataPoint.x),
                                    (C = 100 * (E / p[v].dataSeries.plotUnit.dataPointYSums[C])),
                                    (s = Math.abs(d - this.parent.convertValueToPixel(C))),
                                    s < u && ((u = s), (y = v));
                    else
                    ...
                    if (
                        ...
                        "waterfall" === this.parent.dataSeries[y].type
                            ...
                            : ((w = 1 === q.lineWidth % 2 ? (r(a) ? d : this.parent.convertValueToPixel(x.dataPoint.y) << 0) + 0.5 : r(a) ? d : this.parent.convertValueToPixel(x.dataPoint.y) << 0),
                              (h.text = this.labelFormatter
                ...
                if ("bottom" === this.parent._position || "top" === this.parent._position)
                    "top" === this.parent._position && h.y - h.fontSize / 2 < this.chart.bounds.y1 && (h.y = this.chart.bounds.y1 + h.fontSize / 2),
                        ...
                        b >= this.parent.convertValueToPixel(this.parent.reversed ? this.parent.viewportMaximum : this.parent.viewportMinimum) &&
                            ...
                            (0 < n && (q.moveTo(b, f), q.lineTo(e, k), q.stroke(), (this._hidden = !1)), q.restore(), !r(h.text) && ("number" === typeof h.text.valueOf() || 0 < h.text.length) && h.render(!0));
                if ("left" === this.parent._position || "right" === this.parent._position)
                    "left" === this.parent._position && h.x < this.chart.bounds.x1 && (h.x = this.chart.bounds.x1),
                        ...
                        k >= this.parent.convertValueToPixel(this.parent.reversed ? this.parent.viewportMinimum : this.parent.viewportMaximum) &&
                            f <= this.parent.convertValueToPixel(this.parent.reversed ? this.parent.viewportMaximum : this.parent.viewportMinimum) &&
                            (0 < n && (q.moveTo(b, f), q.lineTo(e, k), q.stroke(), (this._hidden = !1)), q.restore(), !r(h.text) && ("number" === typeof h.text.valueOf() || 0 < h.text.length) && h.render(!0));
            } else {
                if ("bottom" === this.parent._position || "top" === this.parent._position)
                    (b = e = m = 1 === q.lineWidth % 2 ? (a << 0) + 0.5 : a << 0), (f = this.chart.plotArea.y1), (k = this.chart.plotArea.y2), (this.bounds = { x1: b - n / 2, y1: f, x2: e + n / 2, y2: k });
                else if ("left" === this.parent._position || "right" === this.parent._position)
                    (f = k = w = 1 === q.lineWidth % 2 ? (d << 0) + 0.5 : d << 0), (b = this.chart.plotArea.x1), (e = this.chart.plotArea.x2), (this.bounds = { x1: b, y1: f - n / 2, x2: e, y2: k + n / 2 });
                if ("xySwapped" === this.chart.plotInfo.axisPlacement)
                    if ("left" === this.parent._position || "right" === this.parent._position) {
                        C = !1;
                        if (this.parent.labels)
                    ...
                    if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                        ...
                        if (this.chart.axisX)
                            for (var u = 0; u < this.chart.axisX.length; u++) {
                                for (var k = this.chart.axisX[u].convertPixelToValue({ y: d }), h = null, b = 0; b < this.chart.axisX[u].dataSeries.length; b++)
                                    (h = this.chart.axisX[u].dataSeries[b].getDataPointAtX(k, c)) && 0 <= h.index && ((h.dataSeries = this.chart.axisX[u].dataSeries[b]), null !== h.dataPoint.y && m.push(h));
                                h = null;
                            }
                        if (this.chart.axisX2)
                            for (u = 0; u < this.chart.axisX2.length; u++) {
                                k = this.chart.axisX2[u].convertPixelToValue({ y: d });
                                h = null;
                                for (b = 0; b < this.chart.axisX2[u].dataSeries.length; b++)
                                    (h = this.chart.axisX2[u].dataSeries[b].getDataPointAtX(k, c)) && 0 <= h.index && ((h.dataSeries = this.chart.axisX2[u].dataSeries[b]), null !== h.dataPoint.y && m.push(h));
                                h = null;
                            }
                    } else {
                        m = [];
                        if (this.chart.axisX)
                            for (u = 0; u < this.chart.axisX.length; u++)
                                for (k = this.chart.axisX[u].convertPixelToValue({ x: a }), h = null, b = 0; b < this.chart.axisX[u].dataSeries.length; b++)
                                    (h = this.chart.axisX[u].dataSeries[b].getDataPointAtX(k, c)) && 0 <= h.index && ((h.dataSeries = this.chart.axisX[u].dataSeries[b]), null !== h.dataPoint.y && m.push(h));
                        if (this.chart.axisX2)
                            for (u = 0; u < this.chart.axisX2.length; u++)
                                for (k = this.chart.axisX2[u].convertPixelToValue({ x: a }), h = null, b = 0; b < this.chart.axisX2[u].dataSeries.length; b++)
                                    (h = this.chart.axisX2[u].dataSeries[b].getDataPointAtX(k, c)) && 0 <= h.index && ((h.dataSeries = this.chart.axisX2[u].dataSeries[b]), null !== h.dataPoint.y && m.push(h));
                    }
            ...
            for (c = 0; c < a.length; c++) {
                ...
                if ((e = this.chart._eventManager.objectMap[e.dataSeries.dataPointIds[e.index]]) && e.objectType && "dataPoint" === e.objectType) {
                    ...
                    !1 === f.highlightEnabled ||
                        ...
                        "rangeArea" === b.type ||
                        "rangeSplineArea" === b.type
                            ? ((f = b.getMarkerProperties(k, e.x1, e.y1, this.chart.overlaidCanvasCtx)),
                              ...
                              "undefined" !== typeof e.y2 &&
                                  ((f = b.getMarkerProperties(k, e.x1, e.y2, this.chart.overlaidCanvasCtx)),
                                  (f.size = Math.max((1.5 * f.size) << 0, 10)),
                                  (f.borderColor = f.borderColor || "#FFFFFF"),
                                  (f.borderThickness = f.borderThickness || Math.ceil(0.1 * f.size)),
                                  W.drawMarkers([f])))
                            : "bubble" === b.type
                            ? ((f = b.getMarkerProperties(k, e.x1, e.y1, this.chart.overlaidCanvasCtx)), (f.size = e.size), (f.color = "white"), (f.borderColor = "white"), (d.globalAlpha = 0.3), W.drawMarkers([f]), (d.globalAlpha = 1))
                            : "column" === b.type ||
                            ...
                            ? Y(d, e.center, e.radius, "white", b.type, e.startAngle, e.endAngle, 0.3, e.percentInnerRadius)
        ...
        X.prototype.getToolTipInnerHTML = function (a) {
            ...
            if (k && ((this.content && "function" === typeof this.content) || this.contentFormatter)) (a = { chart: this.chart, toolTip: this.options, entries: a }), (d = this.contentFormatter ? this.contentFormatter(a) : this.content(a));
                ...
                for (var r = null, h = "", m = 0; m < a.length; m++)
                    (c = a[m].dataSeries),
                        (b = a[m].dataPoint),
                        (e = a[m].index),
                        (f = ""),
                        ...
                        null === b.toolTipContent ||
                            ...
                            "waterfall" === c.type
                                ? (this.chart.axisX && 1 < this.chart.axisX.length && (f += r != c.axisXIndex ? (c.axisX.title ? c.axisX.title + "<br/>" : "X:{axisXIndex}<br/>") : ""),
                                  (f += b.toolTipContent
                                      ? b.toolTipContent
                                      : c.toolTipContent
                                      ? c.toolTipContent
        ...
        X.prototype.showAtX = function (a, d) {
            ...
            if (this.shared) for (var k = 0; k < this.chart.data.length; k++) (c = this.chart.data[k]), (b = c.getDataPointAtX(a, !1)) && b.dataPoint && !r(b.dataPoint.y) && c.visible && ((b.dataSeries = c), f.push(b));
        ...
        var L = {
            ...
            W = {
                drawMarker: function (a, d, c, b, e, f, k, m) {
                    if (c) {
                        var r = 1;
                        ...
                        "circle" === b
                            ? (c.moveTo(a, d),
                              ...
                              f && c.fill(),
                              m && (k ? c.stroke() : ((r = c.globalAlpha), (c.globalAlpha = 0.15), (c.strokeStyle = "black"), c.stroke(), (c.globalAlpha = r))))
                            : "square" === b
                            ? (c.beginPath(), c.rect(a - e / 2, d - e / 2, e, e), f && c.fill(), m && (k ? c.stroke() : ((r = c.globalAlpha), (c.globalAlpha = 0.15), (c.strokeStyle = "black"), c.stroke(), (c.globalAlpha = r))))
                            : "triangle" === b
                            ? (c.beginPath(),
